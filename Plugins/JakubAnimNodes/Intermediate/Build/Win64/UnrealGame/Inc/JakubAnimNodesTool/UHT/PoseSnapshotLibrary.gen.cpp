...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FPoseSnapshotReference;
class UScriptStruct* FPoseSnapshotReference::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FPoseSnapshotReference.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FPoseSnapshotReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPoseSnapshotReference, (UObject*)Z_Construct_UPackage__Script_JakubAnimNodesTool(), TEXT("PoseSnapshotReference"));
	}
	return Z_Registration_Info_UScriptStruct_FPoseSnapshotReference.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FPoseSnapshotReference.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FPoseSnapshotReference.InnerSingleton, Z_Construct_UScriptStruct_FPoseSnapshotReference_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FPoseSnapshotReference.InnerSingleton;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPoseSnapshotLibrary_DrawSkeletonFromPoseSnapshot_Statics::NewProp_PoseSnapshot = { "PoseSnapshot", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PoseSnapshotLibrary_eventDrawSkeletonFromPoseSnapshot_Parms, PoseSnapshot), Z_Construct_UScriptStruct_FPoseSnapshot, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PoseSnapshot_MetaData), NewProp_PoseSnapshot_MetaData) }; // 4049340394
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPoseSnapshotLibrary_GetBoneTransformFromPoseSnapshot_Statics::NewProp_PoseSnapshot = { "PoseSnapshot", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PoseSnapshotLibrary_eventGetBoneTransformFromPoseSnapshot_Parms, PoseSnapshot), Z_Construct_UScriptStruct_FPoseSnapshot, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PoseSnapshot_MetaData), NewProp_PoseSnapshot_MetaData) }; // 4049340394
...
FClassRegistrationInfo Z_Registration_Info_UClass_UPoseSnapshotLibrary;
UClass* UPoseSnapshotLibrary::GetPrivateStaticClass()
{
	using TClass = UPoseSnapshotLibrary;
	if (!Z_Registration_Info_UClass_UPoseSnapshotLibrary.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("PoseSnapshotLibrary"),
			Z_Registration_Info_UClass_UPoseSnapshotLibrary.InnerSingleton,
			StaticRegisterNativesUPoseSnapshotLibrary,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UPoseSnapshotLibrary.InnerSingleton;
}
UClass* Z_Construct_UClass_UPoseSnapshotLibrary_NoRegister()
{
	return UPoseSnapshotLibrary::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UPoseSnapshotLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UPoseSnapshotLibrary_ConvertToPoseSnapshot, "ConvertToPoseSnapshot" }, // 479537706
		{ &Z_Construct_UFunction_UPoseSnapshotLibrary_DrawSkeletonFromPoseSnapshot, "DrawSkeletonFromPoseSnapshot" }, // 484261503
		{ &Z_Construct_UFunction_UPoseSnapshotLibrary_GetBoneParents, "GetBoneParents" }, // 318491167
		{ &Z_Construct_UFunction_UPoseSnapshotLibrary_GetBoneTransformFromPoseSnapshot, "GetBoneTransformFromPoseSnapshot" }, // 671721220
		{ &Z_Construct_UFunction_UPoseSnapshotLibrary_GetSavedPoseSnapshot, "GetSavedPoseSnapshot" }, // 1928969407
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubAnimNodes_Source_JakubAnimNodesTool_Public_PoseSnapshotLibrary_h__Script_JakubAnimNodesTool_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubAnimNodes_Source_JakubAnimNodesTool_Public_PoseSnapshotLibrary_h__Script_JakubAnimNodesTool_2537546475(TEXT("/Script/JakubAnimNodesTool"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubAnimNodes_Source_JakubAnimNodesTool_Public_PoseSnapshotLibrary_h__Script_JakubAnimNodesTool_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubAnimNodes_Source_JakubAnimNodesTool_Public_PoseSnapshotLibrary_h__Script_JakubAnimNodesTool_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubAnimNodes_Source_JakubAnimNodesTool_Public_PoseSnapshotLibrary_h__Script_JakubAnimNodesTool_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubAnimNodes_Source_JakubAnimNodesTool_Public_PoseSnapshotLibrary_h__Script_JakubAnimNodesTool_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
