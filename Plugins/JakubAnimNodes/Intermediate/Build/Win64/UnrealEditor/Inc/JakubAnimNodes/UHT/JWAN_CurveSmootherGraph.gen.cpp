...
FClassRegistrationInfo Z_Registration_Info_UClass_UJWAN_CurveSmootherGraph;
UClass* UJWAN_CurveSmootherGraph::GetPrivateStaticClass()
{
	using TClass = UJWAN_CurveSmootherGraph;
	if (!Z_Registration_Info_UClass_UJWAN_CurveSmootherGraph.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("JWAN_CurveSmootherGraph"),
			Z_Registration_Info_UClass_UJWAN_CurveSmootherGraph.InnerSingleton,
			StaticRegisterNativesUJWAN_CurveSmootherGraph,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UJWAN_CurveSmootherGraph.InnerSingleton;
}
UClass* Z_Construct_UClass_UJWAN_CurveSmootherGraph_NoRegister()
{
	return UJWAN_CurveSmootherGraph::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_CurveSmootherGraph_h__Script_JakubAnimNodes_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UJWAN_CurveSmootherGraph, UJWAN_CurveSmootherGraph::StaticClass, TEXT("UJWAN_CurveSmootherGraph"), &Z_Registration_Info_UClass_UJWAN_CurveSmootherGraph, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UJWAN_CurveSmootherGraph), 1382163768U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_CurveSmootherGraph_h__Script_JakubAnimNodes_2370922741(TEXT("/Script/JakubAnimNodes"),
	Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_CurveSmootherGraph_h__Script_JakubAnimNodes_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_CurveSmootherGraph_h__Script_JakubAnimNodes_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
