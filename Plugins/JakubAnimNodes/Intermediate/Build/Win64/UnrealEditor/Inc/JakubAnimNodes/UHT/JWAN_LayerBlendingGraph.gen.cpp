...
FClassRegistrationInfo Z_Registration_Info_UClass_UJWAN_LayerBlendingGraph;
UClass* UJWAN_LayerBlendingGraph::GetPrivateStaticClass()
{
	using TClass = UJWAN_LayerBlendingGraph;
	if (!Z_Registration_Info_UClass_UJWAN_LayerBlendingGraph.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("JWAN_LayerBlendingGraph"),
			Z_Registration_Info_UClass_UJWAN_LayerBlendingGraph.InnerSingleton,
			StaticRegisterNativesUJWAN_LayerBlendingGraph,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UJWAN_LayerBlendingGraph.InnerSingleton;
}
UClass* Z_Construct_UClass_UJWAN_LayerBlendingGraph_NoRegister()
{
	return UJWAN_LayerBlendingGraph::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_LayerBlendingGraph_h__Script_JakubAnimNodes_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UJWAN_LayerBlendingGraph, UJWAN_LayerBlendingGraph::StaticClass, TEXT("UJWAN_LayerBlendingGraph"), &Z_Registration_Info_UClass_UJWAN_LayerBlendingGraph, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UJWAN_LayerBlendingGraph), 616554729U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_LayerBlendingGraph_h__Script_JakubAnimNodes_4243973831(TEXT("/Script/JakubAnimNodes"),
	Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_LayerBlendingGraph_h__Script_JakubAnimNodes_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LD05_main_LD05_main_Plugins_JakubAnimNodes_Source_JakubAnimNodes_Public_JWAN_LayerBlendingGraph_h__Script_JakubAnimNodes_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
