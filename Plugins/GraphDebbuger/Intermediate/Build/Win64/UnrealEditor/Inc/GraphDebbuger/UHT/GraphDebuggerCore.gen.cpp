...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FGraphData;
class UScriptStruct* FGraphData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FGraphData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FGraphData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGraphData, (UObject*)Z_Construct_UPackage__Script_GraphDebbuger(), TEXT("GraphData"));
	}
	return Z_Registration_Info_UScriptStruct_FGraphData.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FGraphData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FGraphData.InnerSingleton, Z_Construct_UScriptStruct_FGraphData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FGraphData.InnerSingleton;
}
