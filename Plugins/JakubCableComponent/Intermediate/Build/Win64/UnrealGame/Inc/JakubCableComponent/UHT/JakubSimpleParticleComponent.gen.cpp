...
FClassRegistrationInfo Z_Registration_Info_UClass_UJakubSimpleParticleComponent;
UClass* UJakubSimpleParticleComponent::GetPrivateStaticClass()
{
	using TClass = UJakubSimpleParticleComponent;
	if (!Z_Registration_Info_UClass_UJakubSimpleParticleComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("JakubSimpleParticleComponent"),
			Z_Registration_Info_UClass_UJakubSimpleParticleComponent.InnerSingleton,
			StaticRegisterNativesUJakubSimpleParticleComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UJakubSimpleParticleComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UJakubSimpleParticleComponent_NoRegister()
{
	return UJakubSimpleParticleComponent::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UJakubSimpleParticleComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_AttachComponentToParticle, "AttachComponentToParticle" }, // 2769719271
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_FindBetweenNormals, "FindBetweenNormals" }, // 3064286209
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_GetParticleCurrentLocation, "GetParticleCurrentLocation" }, // 2571652367
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_SetAttachToParticleOffset, "SetAttachToParticleOffset" }, // 2054792372
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h__Script_JakubCableComponent_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UJakubSimpleParticleComponent, UJakubSimpleParticleComponent::StaticClass, TEXT("UJakubSimpleParticleComponent"), &Z_Registration_Info_UClass_UJakubSimpleParticleComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UJakubSimpleParticleComponent), 1030684718U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h__Script_JakubCableComponent_3223247924(TEXT("/Script/JakubCableComponent"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h__Script_JakubCableComponent_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h__Script_JakubCableComponent_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
