...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQueryTest_DotToContextRot;
UClass* UEnvQueryTest_DotToContextRot::GetPrivateStaticClass()
{
	using TClass = UEnvQueryTest_DotToContextRot;
	if (!Z_Registration_Info_UClass_UEnvQueryTest_DotToContextRot.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQueryTest_DotToContextRot"),
			Z_Registration_Info_UClass_UEnvQueryTest_DotToContextRot.InnerSingleton,
			StaticRegisterNativesUEnvQueryTest_DotToContextRot,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQueryTest_DotToContextRot.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQueryTest_DotToContextRot_NoRegister()
{
	return UEnvQueryTest_DotToContextRot::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_DotToContextRot_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryTest_DotToContextRot, UEnvQueryTest_DotToContextRot::StaticClass, TEXT("UEnvQueryTest_DotToContextRot"), &Z_Registration_Info_UClass_UEnvQueryTest_DotToContextRot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryTest_DotToContextRot), 1313849557U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_DotToContextRot_h__Script_ClimbingNavigation_2620715248(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_DotToContextRot_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_DotToContextRot_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
