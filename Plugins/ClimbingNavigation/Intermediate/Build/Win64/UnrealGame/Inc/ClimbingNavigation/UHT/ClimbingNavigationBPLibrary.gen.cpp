...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams;
class UScriptStruct* FClimbNav_OtherPointParams::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClimbNav_OtherPointParams, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("ClimbNav_OtherPointParams"));
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams.InnerSingleton, Z_Construct_UScriptStruct_FClimbNav_OtherPointParams_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint;
class UScriptStruct* FClimbNav_SingleClimbPoint::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClimbNav_SingleClimbPoint, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("ClimbNav_SingleClimbPoint"));
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint.OuterSingleton;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClimbNav_SingleClimbPoint_Statics::NewProp_PossibleNextPoints_Inner = { "PossibleNextPoints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FClimbNav_OtherPointParams, METADATA_PARAMS(0, nullptr) }; // 2281842573
...
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint.InnerSingleton, Z_Construct_UScriptStruct_FClimbNav_SingleClimbPoint_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams;
class UScriptStruct* FClimbNav_InitialLedgeParams::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClimbNav_InitialLedgeParams, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("ClimbNav_InitialLedgeParams"));
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams.InnerSingleton, Z_Construct_UScriptStruct_FClimbNav_InitialLedgeParams_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams;
class UScriptStruct* FClimbNav_SplineLedgeParams::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClimbNav_SplineLedgeParams, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("ClimbNav_SplineLedgeParams"));
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams.InnerSingleton, Z_Construct_UScriptStruct_FClimbNav_SplineLedgeParams_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FNavEdgeParams;
class UScriptStruct* FNavEdgeParams::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FNavEdgeParams.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FNavEdgeParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNavEdgeParams, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("NavEdgeParams"));
	}
	return Z_Registration_Info_UScriptStruct_FNavEdgeParams.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FNavEdgeParams.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FNavEdgeParams.InnerSingleton, Z_Construct_UScriptStruct_FNavEdgeParams_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FNavEdgeParams.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData;
class UScriptStruct* FClimbNav_FullPathData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClimbNav_FullPathData, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("ClimbNav_FullPathData"));
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData.InnerSingleton, Z_Construct_UScriptStruct_FClimbNav_FullPathData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData.InnerSingleton;
}
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UClimbingNavigationBPLibrary_TryFindPathForClimbNav_Statics::NewProp_PathPoints = { "PathPoints", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ClimbingNavigationBPLibrary_eventTryFindPathForClimbNav_Parms, PathPoints), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 1111028097
...
FClassRegistrationInfo Z_Registration_Info_UClass_UClimbingNavigationBPLibrary;
UClass* UClimbingNavigationBPLibrary::GetPrivateStaticClass()
{
	using TClass = UClimbingNavigationBPLibrary;
	if (!Z_Registration_Info_UClass_UClimbingNavigationBPLibrary.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("ClimbingNavigationBPLibrary"),
			Z_Registration_Info_UClass_UClimbingNavigationBPLibrary.InnerSingleton,
			StaticRegisterNativesUClimbingNavigationBPLibrary,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UClimbingNavigationBPLibrary.InnerSingleton;
}
UClass* Z_Construct_UClass_UClimbingNavigationBPLibrary_NoRegister()
{
	return UClimbingNavigationBPLibrary::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UClimbingNavigationBPLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_DoesLineIntersectBox, "DoesLineIntersectBox" }, // 551596600
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_DrawDebugArc, "DrawDebugArc" }, // 2972652701
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_DrawDebugPartCylinder, "DrawDebugPartCylinder" }, // 1032202064
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_FindClosestEdgeOnNavMesh, "FindClosestEdgeOnNavMesh" }, // 1730012146
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_FindClosestNavMeshEdge, "FindClosestNavMeshEdge" }, // 2256088041
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_FindExternalEdgesInBox, "FindExternalEdgesInBox" }, // 1084271976
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_GetPathFollowingAcceptanceRadius, "GetPathFollowingAcceptanceRadius" }, // 2136366440
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_GetPathFollowingCurrentNavCost, "GetPathFollowingCurrentNavCost" }, // 1485713031
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_GetPathFollowingHasPartialPath, "GetPathFollowingHasPartialPath" }, // 3708751759
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_GetPathFollowingNavLinkMove, "GetPathFollowingNavLinkMove" }, // 1690512177
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_GetPathFollowingSegmentIsNavLink, "GetPathFollowingSegmentIsNavLink" }, // 2670641189
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_IsPointInsideCylinderSegment, "IsPointInsideCylinderSegment" }, // 3776289777
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_IsPointOnSegment, "IsPointOnSegment" }, // 755588988
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_SetPathFollowingAcceptanceRadius, "SetPathFollowingAcceptanceRadius" }, // 1368254439
		{ &Z_Construct_UFunction_UClimbingNavigationBPLibrary_TryFindPathForClimbNav, "TryFindPathForClimbNav" }, // 804638070
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FClimbNav_OtherPointParams::StaticStruct, Z_Construct_UScriptStruct_FClimbNav_OtherPointParams_Statics::NewStructOps, TEXT("ClimbNav_OtherPointParams"), &Z_Registration_Info_UScriptStruct_FClimbNav_OtherPointParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClimbNav_OtherPointParams), 2281842573U) },
		{ FClimbNav_SingleClimbPoint::StaticStruct, Z_Construct_UScriptStruct_FClimbNav_SingleClimbPoint_Statics::NewStructOps, TEXT("ClimbNav_SingleClimbPoint"), &Z_Registration_Info_UScriptStruct_FClimbNav_SingleClimbPoint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClimbNav_SingleClimbPoint), 1111028097U) },
		{ FClimbNav_InitialLedgeParams::StaticStruct, Z_Construct_UScriptStruct_FClimbNav_InitialLedgeParams_Statics::NewStructOps, TEXT("ClimbNav_InitialLedgeParams"), &Z_Registration_Info_UScriptStruct_FClimbNav_InitialLedgeParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClimbNav_InitialLedgeParams), 319453759U) },
		{ FClimbNav_SplineLedgeParams::StaticStruct, Z_Construct_UScriptStruct_FClimbNav_SplineLedgeParams_Statics::NewStructOps, TEXT("ClimbNav_SplineLedgeParams"), &Z_Registration_Info_UScriptStruct_FClimbNav_SplineLedgeParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClimbNav_SplineLedgeParams), 2916281684U) },
		{ FNavEdgeParams::StaticStruct, Z_Construct_UScriptStruct_FNavEdgeParams_Statics::NewStructOps, TEXT("NavEdgeParams"), &Z_Registration_Info_UScriptStruct_FNavEdgeParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNavEdgeParams), 224396110U) },
		{ FClimbNav_FullPathData::StaticStruct, Z_Construct_UScriptStruct_FClimbNav_FullPathData_Statics::NewStructOps, TEXT("ClimbNav_FullPathData"), &Z_Registration_Info_UScriptStruct_FClimbNav_FullPathData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClimbNav_FullPathData), 1164322782U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UClimbingNavigationBPLibrary, UClimbingNavigationBPLibrary::StaticClass, TEXT("UClimbingNavigationBPLibrary"), &Z_Registration_Info_UClass_UClimbingNavigationBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClimbingNavigationBPLibrary), 2443342489U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_3628987067(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_ClimbingNavigationBPLibrary_h__Script_ClimbingNavigation_Statics::EnumInfo));
// ********** End Registration *********************************************************************
