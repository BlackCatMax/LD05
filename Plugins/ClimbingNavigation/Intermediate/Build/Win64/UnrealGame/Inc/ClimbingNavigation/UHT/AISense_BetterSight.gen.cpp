...
FClassRegistrationInfo Z_Registration_Info_UClass_UAISense_BetterSight;
UClass* UAISense_BetterSight::GetPrivateStaticClass()
{
	using TClass = UAISense_BetterSight;
	if (!Z_Registration_Info_UClass_UAISense_BetterSight.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AISense_BetterSight"),
			Z_Registration_Info_UClass_UAISense_BetterSight.InnerSingleton,
			StaticRegisterNativesUAISense_BetterSight,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAISense_BetterSight.InnerSingleton;
}
UClass* Z_Construct_UClass_UAISense_BetterSight_NoRegister()
{
	return UAISense_BetterSight::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AISense_BetterSight_h__Script_ClimbingNavigation_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAISense_BetterSight, UAISense_BetterSight::StaticClass, TEXT("UAISense_BetterSight"), &Z_Registration_Info_UClass_UAISense_BetterSight, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISense_BetterSight), 3454673291U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AISense_BetterSight_h__Script_ClimbingNavigation_1328434519(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AISense_BetterSight_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AISense_BetterSight_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AISense_BetterSight_h__Script_ClimbingNavigation_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AISense_BetterSight_h__Script_ClimbingNavigation_Statics::EnumInfo));
// ********** End Registration *********************************************************************
