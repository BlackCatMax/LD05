...
FClassRegistrationInfo Z_Registration_Info_UClass_UDynamicNavLinkComponent;
UClass* UDynamicNavLinkComponent::GetPrivateStaticClass()
{
	using TClass = UDynamicNavLinkComponent;
	if (!Z_Registration_Info_UClass_UDynamicNavLinkComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("DynamicNavLinkComponent"),
			Z_Registration_Info_UClass_UDynamicNavLinkComponent.InnerSingleton,
			StaticRegisterNativesUDynamicNavLinkComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UDynamicNavLinkComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UDynamicNavLinkComponent_NoRegister()
{
	return UDynamicNavLinkComponent::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UDynamicNavLinkComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UDynamicNavLinkComponent_AddNewNavLink, "AddNewNavLink" }, // 647780303
		{ &Z_Construct_UFunction_UDynamicNavLinkComponent_RebuildNavLinks, "RebuildNavLinks" }, // 2595421864
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_DynamicNavLinkComponent_h__Script_ClimbingNavigation_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDynamicNavLinkComponent, UDynamicNavLinkComponent::StaticClass, TEXT("UDynamicNavLinkComponent"), &Z_Registration_Info_UClass_UDynamicNavLinkComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDynamicNavLinkComponent), 3159945298U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_DynamicNavLinkComponent_h__Script_ClimbingNavigation_2526364035(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_DynamicNavLinkComponent_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_DynamicNavLinkComponent_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_DynamicNavLinkComponent_h__Script_ClimbingNavigation_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_DynamicNavLinkComponent_h__Script_ClimbingNavigation_Statics::EnumInfo));
// ********** End Registration *********************************************************************
