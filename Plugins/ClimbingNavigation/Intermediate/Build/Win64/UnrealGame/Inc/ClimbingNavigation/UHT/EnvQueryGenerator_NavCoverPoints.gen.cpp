...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQueryGenerator_NavCoverPoints;
UClass* UEnvQueryGenerator_NavCoverPoints::GetPrivateStaticClass()
{
	using TClass = UEnvQueryGenerator_NavCoverPoints;
	if (!Z_Registration_Info_UClass_UEnvQueryGenerator_NavCoverPoints.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQueryGenerator_NavCoverPoints"),
			Z_Registration_Info_UClass_UEnvQueryGenerator_NavCoverPoints.InnerSingleton,
			StaticRegisterNativesUEnvQueryGenerator_NavCoverPoints,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQueryGenerator_NavCoverPoints.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQueryGenerator_NavCoverPoints_NoRegister()
{
	return UEnvQueryGenerator_NavCoverPoints::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryGenerator_NavCoverPoints_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryGenerator_NavCoverPoints, UEnvQueryGenerator_NavCoverPoints::StaticClass, TEXT("UEnvQueryGenerator_NavCoverPoints"), &Z_Registration_Info_UClass_UEnvQueryGenerator_NavCoverPoints, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryGenerator_NavCoverPoints), 3214716084U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryGenerator_NavCoverPoints_h__Script_ClimbingNavigation_462119255(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryGenerator_NavCoverPoints_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryGenerator_NavCoverPoints_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
