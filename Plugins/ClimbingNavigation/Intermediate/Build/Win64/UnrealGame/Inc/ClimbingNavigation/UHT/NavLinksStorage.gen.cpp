...
FClassRegistrationInfo Z_Registration_Info_UClass_ANavLinksStorage;
UClass* ANavLinksStorage::GetPrivateStaticClass()
{
	using TClass = ANavLinksStorage;
	if (!Z_Registration_Info_UClass_ANavLinksStorage.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("NavLinksStorage"),
			Z_Registration_Info_UClass_ANavLinksStorage.InnerSingleton,
			StaticRegisterNativesANavLinksStorage,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ANavLinksStorage.InnerSingleton;
}
UClass* Z_Construct_UClass_ANavLinksStorage_NoRegister()
{
	return ANavLinksStorage::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksStorage_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ANavLinksStorage, ANavLinksStorage::StaticClass, TEXT("ANavLinksStorage"), &Z_Registration_Info_UClass_ANavLinksStorage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavLinksStorage), 3585122894U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksStorage_h__Script_ClimbingNavigation_3235856748(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksStorage_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksStorage_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
