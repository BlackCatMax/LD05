...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FWeightFunction;
class UScriptStruct* FWeightFunction::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FWeightFunction.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FWeightFunction.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeightFunction, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("WeightFunction"));
	}
	return Z_Registration_Info_UScriptStruct_FWeightFunction.OuterSingleton;
}
struct Z_Construct_UScriptStruct_FWeightFunction_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bInverseRange_MetaData[] = {
		{ "Category", "Weight" },
		{ "ModuleRelativePath", "Public/NavQuery_HidingLocSearchParams.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MinAccetableValueFilter_MetaData[] = {
		{ "Category", "Weight" },
		{ "ModuleRelativePath", "Public/NavQuery_HidingLocSearchParams.h" },
	};
	...
	static void NewProp_bInverseRange_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bInverseRange;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_MinAccetableValueFilter;
...
void Z_Construct_UScriptStruct_FWeightFunction_Statics::NewProp_bInverseRange_SetBit(void* Obj)
{
	((FWeightFunction*)Obj)->bInverseRange = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWeightFunction_Statics::NewProp_bInverseRange = { "bInverseRange", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FWeightFunction), &Z_Construct_UScriptStruct_FWeightFunction_Statics::NewProp_bInverseRange_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bInverseRange_MetaData), NewProp_bInverseRange_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWeightFunction_Statics::NewProp_MinAccetableValueFilter = { "MinAccetableValueFilter", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWeightFunction, MinAccetableValueFilter), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MinAccetableValueFilter_MetaData), NewProp_MinAccetableValueFilter_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWeightFunction_Statics::NewProp_DistributionCurve = { "DistributionCurve", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWeightFunction, DistributionCurve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DistributionCurve_MetaData), NewProp_DistributionCurve_MetaData) }; // 3139605666
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FWeightFunction_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FWeightFunction_Statics::NewProp_bInverseRange,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FWeightFunction_Statics::NewProp_MinAccetableValueFilter,
...
{
	if (!Z_Registration_Info_UScriptStruct_FWeightFunction.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FWeightFunction.InnerSingleton, Z_Construct_UScriptStruct_FWeightFunction_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FWeightFunction.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UNavQuery_HidingLocSearchParams;
UClass* UNavQuery_HidingLocSearchParams::GetPrivateStaticClass()
{
	using TClass = UNavQuery_HidingLocSearchParams;
	if (!Z_Registration_Info_UClass_UNavQuery_HidingLocSearchParams.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("NavQuery_HidingLocSearchParams"),
			Z_Registration_Info_UClass_UNavQuery_HidingLocSearchParams.InnerSingleton,
			StaticRegisterNativesUNavQuery_HidingLocSearchParams,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UNavQuery_HidingLocSearchParams.InnerSingleton;
}
UClass* Z_Construct_UClass_UNavQuery_HidingLocSearchParams_NoRegister()
{
	return UNavQuery_HidingLocSearchParams::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_UseAsMaximalizeSearcher_MetaData[] = {
		{ "Category", "Query Config|Search Type" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/*An important value that determines the operating mode of the element evaluating the weights for individual points. \nIn the default minimization mode, the points with the lowest weights will be considered. Otherwise, the function will \nseek the highest weight value for CoverPoint.*/" },
#endif
		{ "ModuleRelativePath", "Public/NavQuery_HidingLocSearchParams.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "An important value that determines the operating mode of the element evaluating the weights for individual points.\nIn the default minimization mode, the points with the lowest weights will be considered. Otherwise, the function will\nseek the highest weight value for CoverPoint." },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WallHitWeight_MetaData[] = {
		{ "Category", "Query Config|Weights" },
		{ "ModuleRelativePath", "Public/NavQuery_HidingLocSearchParams.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BaseDistanceCalcOnCurrentPointAlpha_MetaData[] = {
		{ "Category", "Query Config|Angle Weight" },
		{ "ClampMax", "1.000000" },
		{ "ClampMin", "0.000000" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//this is the ratio of TraceOrigin to CurrentCoverPoint\n" },
#endif
		{ "ModuleRelativePath", "Public/NavQuery_HidingLocSearchParams.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "this is the ratio of TraceOrigin to CurrentCoverPoint" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SlerpAngleWhenPointIsInNegativePlane_MetaData[] = {
		{ "Category", "Query Config|Angle Weight" },
		{ "ClampMax", "1.000000" },
		{ "ClampMin", "0.000000" },
		{ "ModuleRelativePath", "Public/NavQuery_HidingLocSearchParams.h" },
	...
	static void NewProp_UseAsMaximalizeSearcher_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_UseAsMaximalizeSearcher;
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_WallHitWeight;
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_BaseDistanceCalcOnCurrentPointAlpha;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_SlerpAngleWhenPointIsInNegativePlane;
...
void Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_UseAsMaximalizeSearcher_SetBit(void* Obj)
{
	((UNavQuery_HidingLocSearchParams*)Obj)->UseAsMaximalizeSearcher = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_UseAsMaximalizeSearcher = { "UseAsMaximalizeSearcher", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNavQuery_HidingLocSearchParams), &Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_UseAsMaximalizeSearcher_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_UseAsMaximalizeSearcher_MetaData), NewProp_UseAsMaximalizeSearcher_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_PathLenghtToPointWeight = { "PathLenghtToPointWeight", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNavQuery_HidingLocSearchParams, PathLenghtToPointWeight), Z_Construct_UScriptStruct_FWeightFunction, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PathLenghtToPointWeight_MetaData), NewProp_PathLenghtToPointWeight_MetaData) }; // 2496168406
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_PointAngleWeight = { "PointAngleWeight", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNavQuery_HidingLocSearchParams, PointAngleWeight), Z_Construct_UScriptStruct_FWeightFunction, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PointAngleWeight_MetaData), NewProp_PointAngleWeight_MetaData) }; // 2496168406
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_WallHitWeight = { "WallHitWeight", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNavQuery_HidingLocSearchParams, WallHitWeight), Z_Construct_UScriptStruct_FWeightFunction, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WallHitWeight_MetaData), NewProp_WallHitWeight_MetaData) }; // 2496168406
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_BaseDistanceCalcOnCurrentPointAlpha = { "BaseDistanceCalcOnCurrentPointAlpha", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNavQuery_HidingLocSearchParams, BaseDistanceCalcOnCurrentPointAlpha), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BaseDistanceCalcOnCurrentPointAlpha_MetaData), NewProp_BaseDistanceCalcOnCurrentPointAlpha_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_SlerpAngleWhenPointIsInNegativePlane = { "SlerpAngleWhenPointIsInNegativePlane", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNavQuery_HidingLocSearchParams, SlerpAngleWhenPointIsInNegativePlane), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SlerpAngleWhenPointIsInNegativePlane_MetaData), NewProp_SlerpAngleWhenPointIsInNegativePlane_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_UseAsMaximalizeSearcher,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_WallHitWeight,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_BaseDistanceCalcOnCurrentPointAlpha,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNavQuery_HidingLocSearchParams_Statics::NewProp_SlerpAngleWhenPointIsInNegativePlane,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeightFunction::StaticStruct, Z_Construct_UScriptStruct_FWeightFunction_Statics::NewStructOps, TEXT("WeightFunction"), &Z_Registration_Info_UScriptStruct_FWeightFunction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeightFunction), 2496168406U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_2818542017(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_HidingLocSearchParams_h__Script_ClimbingNavigation_Statics::EnumInfo));
// ********** End Registration *********************************************************************
