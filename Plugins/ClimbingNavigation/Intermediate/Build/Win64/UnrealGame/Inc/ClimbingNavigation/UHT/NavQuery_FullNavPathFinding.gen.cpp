...
FClassRegistrationInfo Z_Registration_Info_UClass_UNavQuery_FullNavPathFinding;
UClass* UNavQuery_FullNavPathFinding::GetPrivateStaticClass()
{
	using TClass = UNavQuery_FullNavPathFinding;
	if (!Z_Registration_Info_UClass_UNavQuery_FullNavPathFinding.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("NavQuery_FullNavPathFinding"),
			Z_Registration_Info_UClass_UNavQuery_FullNavPathFinding.InnerSingleton,
			StaticRegisterNativesUNavQuery_FullNavPathFinding,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UNavQuery_FullNavPathFinding.InnerSingleton;
}
UClass* Z_Construct_UClass_UNavQuery_FullNavPathFinding_NoRegister()
{
	return UNavQuery_FullNavPathFinding::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_FullNavPathFinding_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNavQuery_FullNavPathFinding, UNavQuery_FullNavPathFinding::StaticClass, TEXT("UNavQuery_FullNavPathFinding"), &Z_Registration_Info_UClass_UNavQuery_FullNavPathFinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNavQuery_FullNavPathFinding), 1936723443U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_FullNavPathFinding_h__Script_ClimbingNavigation_2192538956(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_FullNavPathFinding_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavQuery_FullNavPathFinding_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
