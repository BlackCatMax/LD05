...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQueryTest_Composite;
UClass* UEnvQueryTest_Composite::GetPrivateStaticClass()
{
	using TClass = UEnvQueryTest_Composite;
	if (!Z_Registration_Info_UClass_UEnvQueryTest_Composite.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQueryTest_Composite"),
			Z_Registration_Info_UClass_UEnvQueryTest_Composite.InnerSingleton,
			StaticRegisterNativesUEnvQueryTest_Composite,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQueryTest_Composite.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQueryTest_Composite_NoRegister()
{
	return UEnvQueryTest_Composite::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_Composite_h__Script_ClimbingNavigation_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_Composite_h__Script_ClimbingNavigation_2543277206(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_Composite_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_Composite_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_Composite_h__Script_ClimbingNavigation_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_Composite_h__Script_ClimbingNavigation_Statics::EnumInfo));
// ********** End Registration *********************************************************************
