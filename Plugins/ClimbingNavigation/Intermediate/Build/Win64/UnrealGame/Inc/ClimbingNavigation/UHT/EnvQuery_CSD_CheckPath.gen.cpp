...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQuery_CSD_CheckPath;
UClass* UEnvQuery_CSD_CheckPath::GetPrivateStaticClass()
{
	using TClass = UEnvQuery_CSD_CheckPath;
	if (!Z_Registration_Info_UClass_UEnvQuery_CSD_CheckPath.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQuery_CSD_CheckPath"),
			Z_Registration_Info_UClass_UEnvQuery_CSD_CheckPath.InnerSingleton,
			StaticRegisterNativesUEnvQuery_CSD_CheckPath,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQuery_CSD_CheckPath.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQuery_CSD_CheckPath_NoRegister()
{
	return UEnvQuery_CSD_CheckPath::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_CheckPath_h__Script_ClimbingNavigation_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQuery_CSD_CheckPath, UEnvQuery_CSD_CheckPath::StaticClass, TEXT("UEnvQuery_CSD_CheckPath"), &Z_Registration_Info_UClass_UEnvQuery_CSD_CheckPath, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQuery_CSD_CheckPath), 3989477674U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_CheckPath_h__Script_ClimbingNavigation_2216145851(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_CheckPath_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_CheckPath_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_CheckPath_h__Script_ClimbingNavigation_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_CheckPath_h__Script_ClimbingNavigation_Statics::EnumInfo));
// ********** End Registration *********************************************************************
