...
static FName NAME_UEnvQuery_CustomScoreDefine_SetScorePerPoint = FName(TEXT("SetScorePerPoint"));
...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQuery_CustomScoreDefine;
UClass* UEnvQuery_CustomScoreDefine::GetPrivateStaticClass()
{
	using TClass = UEnvQuery_CustomScoreDefine;
	if (!Z_Registration_Info_UClass_UEnvQuery_CustomScoreDefine.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQuery_CustomScoreDefine"),
			Z_Registration_Info_UClass_UEnvQuery_CustomScoreDefine.InnerSingleton,
			StaticRegisterNativesUEnvQuery_CustomScoreDefine,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQuery_CustomScoreDefine.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQuery_CustomScoreDefine_NoRegister()
{
	return UEnvQuery_CustomScoreDefine::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UEnvQuery_CustomScoreDefine_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UEnvQuery_CustomScoreDefine_SetScorePerPoint, "SetScorePerPoint" }, // 373365881
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CustomScoreDefine_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQuery_CustomScoreDefine, UEnvQuery_CustomScoreDefine::StaticClass, TEXT("UEnvQuery_CustomScoreDefine"), &Z_Registration_Info_UClass_UEnvQuery_CustomScoreDefine, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQuery_CustomScoreDefine), 1707382123U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CustomScoreDefine_h__Script_ClimbingNavigation_3327028279(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CustomScoreDefine_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CustomScoreDefine_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
