...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQuery_CSD_DistanceToVector;
UClass* UEnvQuery_CSD_DistanceToVector::GetPrivateStaticClass()
{
	using TClass = UEnvQuery_CSD_DistanceToVector;
	if (!Z_Registration_Info_UClass_UEnvQuery_CSD_DistanceToVector.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQuery_CSD_DistanceToVector"),
			Z_Registration_Info_UClass_UEnvQuery_CSD_DistanceToVector.InnerSingleton,
			StaticRegisterNativesUEnvQuery_CSD_DistanceToVector,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQuery_CSD_DistanceToVector.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQuery_CSD_DistanceToVector_NoRegister()
{
	return UEnvQuery_CSD_DistanceToVector::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_DistanceToVector_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQuery_CSD_DistanceToVector, UEnvQuery_CSD_DistanceToVector::StaticClass, TEXT("UEnvQuery_CSD_DistanceToVector"), &Z_Registration_Info_UClass_UEnvQuery_CSD_DistanceToVector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQuery_CSD_DistanceToVector), 1512101392U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_DistanceToVector_h__Script_ClimbingNavigation_2308099599(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_DistanceToVector_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CSD_DistanceToVector_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
