...
FClassRegistrationInfo Z_Registration_Info_UClass_UAGLS_NavLinkCustomComponent;
UClass* UAGLS_NavLinkCustomComponent::GetPrivateStaticClass()
{
	using TClass = UAGLS_NavLinkCustomComponent;
	if (!Z_Registration_Info_UClass_UAGLS_NavLinkCustomComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AGLS_NavLinkCustomComponent"),
			Z_Registration_Info_UClass_UAGLS_NavLinkCustomComponent.InnerSingleton,
			StaticRegisterNativesUAGLS_NavLinkCustomComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAGLS_NavLinkCustomComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UAGLS_NavLinkCustomComponent_NoRegister()
{
	return UAGLS_NavLinkCustomComponent::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AGLS_NavLinkCustomComponent_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAGLS_NavLinkCustomComponent, UAGLS_NavLinkCustomComponent::StaticClass, TEXT("UAGLS_NavLinkCustomComponent"), &Z_Registration_Info_UClass_UAGLS_NavLinkCustomComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAGLS_NavLinkCustomComponent), 2744954785U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AGLS_NavLinkCustomComponent_h__Script_ClimbingNavigation_1594120662(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AGLS_NavLinkCustomComponent_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_AGLS_NavLinkCustomComponent_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
