...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine;
class UScriptStruct* FNavLinks_SingleLine::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNavLinks_SingleLine, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("NavLinks_SingleLine"));
	}
	return Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine.InnerSingleton, Z_Construct_UScriptStruct_FNavLinks_SingleLine_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges;
class UScriptStruct* FNavLinks_FloorEdges::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNavLinks_FloorEdges, (UObject*)Z_Construct_UPackage__Script_ClimbingNavigation(), TEXT("NavLinks_FloorEdges"));
	}
	return Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges.OuterSingleton;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNavLinks_FloorEdges_Statics::NewProp_NavEdges_Inner = { "NavEdges", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNavLinks_SingleLine, METADATA_PARAMS(0, nullptr) }; // 2872763609
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNavLinks_FloorEdges_Statics::NewProp_NavEdges = { "NavEdges", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNavLinks_FloorEdges, NavEdges), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NavEdges_MetaData), NewProp_NavEdges_MetaData) }; // 2872763609
...
{
	if (!Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges.InnerSingleton, Z_Construct_UScriptStruct_FNavLinks_FloorEdges_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_ANavLinksAutoGenerator;
UClass* ANavLinksAutoGenerator::GetPrivateStaticClass()
{
	using TClass = ANavLinksAutoGenerator;
	if (!Z_Registration_Info_UClass_ANavLinksAutoGenerator.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("NavLinksAutoGenerator"),
			Z_Registration_Info_UClass_ANavLinksAutoGenerator.InnerSingleton,
			StaticRegisterNativesANavLinksAutoGenerator,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ANavLinksAutoGenerator.InnerSingleton;
}
UClass* Z_Construct_UClass_ANavLinksAutoGenerator_NoRegister()
{
	return ANavLinksAutoGenerator::GetPrivateStaticClass();
}
struct Z_Construct_UClass_ANavLinksAutoGenerator_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ANavLinksAutoGenerator_GenerateNavLinks, "GenerateNavLinks" }, // 2020562412
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksAutoGenerator_h__Script_ClimbingNavigation_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FNavLinks_SingleLine::StaticStruct, Z_Construct_UScriptStruct_FNavLinks_SingleLine_Statics::NewStructOps, TEXT("NavLinks_SingleLine"), &Z_Registration_Info_UScriptStruct_FNavLinks_SingleLine, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNavLinks_SingleLine), 2872763609U) },
		{ FNavLinks_FloorEdges::StaticStruct, Z_Construct_UScriptStruct_FNavLinks_FloorEdges_Statics::NewStructOps, TEXT("NavLinks_FloorEdges"), &Z_Registration_Info_UScriptStruct_FNavLinks_FloorEdges, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNavLinks_FloorEdges), 2328301975U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ANavLinksAutoGenerator, ANavLinksAutoGenerator::StaticClass, TEXT("ANavLinksAutoGenerator"), &Z_Registration_Info_UClass_ANavLinksAutoGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavLinksAutoGenerator), 1683904465U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksAutoGenerator_h__Script_ClimbingNavigation_1324262893(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksAutoGenerator_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksAutoGenerator_h__Script_ClimbingNavigation_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksAutoGenerator_h__Script_ClimbingNavigation_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_NavLinksAutoGenerator_h__Script_ClimbingNavigation_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
