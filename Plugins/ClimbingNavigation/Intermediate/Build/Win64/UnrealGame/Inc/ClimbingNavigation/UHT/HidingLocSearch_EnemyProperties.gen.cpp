...
FClassRegistrationInfo Z_Registration_Info_UClass_UHidingLocSearch_EnemyProperties;
UClass* UHidingLocSearch_EnemyProperties::GetPrivateStaticClass()
{
	using TClass = UHidingLocSearch_EnemyProperties;
	if (!Z_Registration_Info_UClass_UHidingLocSearch_EnemyProperties.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HidingLocSearch_EnemyProperties"),
			Z_Registration_Info_UClass_UHidingLocSearch_EnemyProperties.InnerSingleton,
			StaticRegisterNativesUHidingLocSearch_EnemyProperties,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHidingLocSearch_EnemyProperties.InnerSingleton;
}
UClass* Z_Construct_UClass_UHidingLocSearch_EnemyProperties_NoRegister()
{
	return UHidingLocSearch_EnemyProperties::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHidingLocSearch_EnemyProperties_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHidingLocSearch_EnemyProperties_GetCurrentEnemySightParams, "GetCurrentEnemySightParams" }, // 3080740861
		{ &Z_Construct_UFunction_UHidingLocSearch_EnemyProperties_GetPredictedEnemyTransform, "GetPredictedEnemyTransform" }, // 4129298058
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h__Script_ClimbingNavigation_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h__Script_ClimbingNavigation_3152441833(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
