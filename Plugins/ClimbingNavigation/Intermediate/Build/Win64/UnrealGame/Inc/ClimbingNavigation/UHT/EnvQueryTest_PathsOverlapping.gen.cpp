...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQueryTest_PathsOverlapping;
UClass* UEnvQueryTest_PathsOverlapping::GetPrivateStaticClass()
{
	using TClass = UEnvQueryTest_PathsOverlapping;
	if (!Z_Registration_Info_UClass_UEnvQueryTest_PathsOverlapping.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQueryTest_PathsOverlapping"),
			Z_Registration_Info_UClass_UEnvQueryTest_PathsOverlapping.InnerSingleton,
			StaticRegisterNativesUEnvQueryTest_PathsOverlapping,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQueryTest_PathsOverlapping.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQueryTest_PathsOverlapping_NoRegister()
{
	return UEnvQueryTest_PathsOverlapping::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_PathsOverlapping_h__Script_ClimbingNavigation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryTest_PathsOverlapping, UEnvQueryTest_PathsOverlapping::StaticClass, TEXT("UEnvQueryTest_PathsOverlapping"), &Z_Registration_Info_UClass_UEnvQueryTest_PathsOverlapping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryTest_PathsOverlapping), 2351663556U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_PathsOverlapping_h__Script_ClimbingNavigation_2542116629(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_PathsOverlapping_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQueryTest_PathsOverlapping_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
