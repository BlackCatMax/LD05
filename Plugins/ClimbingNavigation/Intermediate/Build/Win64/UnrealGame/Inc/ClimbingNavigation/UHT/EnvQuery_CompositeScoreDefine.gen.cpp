...
FClassRegistrationInfo Z_Registration_Info_UClass_UEnvQuery_CompositeScoreDefine;
UClass* UEnvQuery_CompositeScoreDefine::GetPrivateStaticClass()
{
	using TClass = UEnvQuery_CompositeScoreDefine;
	if (!Z_Registration_Info_UClass_UEnvQuery_CompositeScoreDefine.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EnvQuery_CompositeScoreDefine"),
			Z_Registration_Info_UClass_UEnvQuery_CompositeScoreDefine.InnerSingleton,
			StaticRegisterNativesUEnvQuery_CompositeScoreDefine,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEnvQuery_CompositeScoreDefine.InnerSingleton;
}
UClass* Z_Construct_UClass_UEnvQuery_CompositeScoreDefine_NoRegister()
{
	return UEnvQuery_CompositeScoreDefine::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQuery_CompositeScoreDefine_Statics::NewProp_BoolValue = { "BoolValue", nullptr, (EPropertyFlags)0x0010008000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEnvQuery_CompositeScoreDefine, BoolValue), Z_Construct_UScriptStruct_FAIDataProviderBoolValue, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BoolValue_MetaData), NewProp_BoolValue_MetaData) }; // 4154625256
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CompositeScoreDefine_h__Script_ClimbingNavigation_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQuery_CompositeScoreDefine, UEnvQuery_CompositeScoreDefine::StaticClass, TEXT("UEnvQuery_CompositeScoreDefine"), &Z_Registration_Info_UClass_UEnvQuery_CompositeScoreDefine, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQuery_CompositeScoreDefine), 3584808419U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CompositeScoreDefine_h__Script_ClimbingNavigation_1729004849(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CompositeScoreDefine_h__Script_ClimbingNavigation_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CompositeScoreDefine_h__Script_ClimbingNavigation_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CompositeScoreDefine_h__Script_ClimbingNavigation_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_EnvQuery_CompositeScoreDefine_h__Script_ClimbingNavigation_Statics::EnumInfo));
// ********** End Registration *********************************************************************
