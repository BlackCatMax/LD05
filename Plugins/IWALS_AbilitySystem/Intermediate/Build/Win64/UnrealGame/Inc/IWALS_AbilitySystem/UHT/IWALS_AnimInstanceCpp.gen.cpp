...
FClassRegistrationInfo Z_Registration_Info_UClass_UIWALS_AnimInstanceCpp;
UClass* UIWALS_AnimInstanceCpp::GetPrivateStaticClass()
{
	using TClass = UIWALS_AnimInstanceCpp;
	if (!Z_Registration_Info_UClass_UIWALS_AnimInstanceCpp.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("IWALS_AnimInstanceCpp"),
			Z_Registration_Info_UClass_UIWALS_AnimInstanceCpp.InnerSingleton,
			StaticRegisterNativesUIWALS_AnimInstanceCpp,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UIWALS_AnimInstanceCpp.InnerSingleton;
}
UClass* Z_Construct_UClass_UIWALS_AnimInstanceCpp_NoRegister()
{
	return UIWALS_AnimInstanceCpp::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AnimInstanceCpp_h__Script_IWALS_AbilitySystem_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UIWALS_AnimInstanceCpp, UIWALS_AnimInstanceCpp::StaticClass, TEXT("UIWALS_AnimInstanceCpp"), &Z_Registration_Info_UClass_UIWALS_AnimInstanceCpp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIWALS_AnimInstanceCpp), 3118461438U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AnimInstanceCpp_h__Script_IWALS_AbilitySystem_2634120321(TEXT("/Script/IWALS_AbilitySystem"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AnimInstanceCpp_h__Script_IWALS_AbilitySystem_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AnimInstanceCpp_h__Script_IWALS_AbilitySystem_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
