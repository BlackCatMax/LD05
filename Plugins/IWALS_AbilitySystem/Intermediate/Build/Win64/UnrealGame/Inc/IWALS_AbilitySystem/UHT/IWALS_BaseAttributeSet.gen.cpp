...
FClassRegistrationInfo Z_Registration_Info_UClass_UIWALS_BaseAttributeSet;
UClass* UIWALS_BaseAttributeSet::GetPrivateStaticClass()
{
	using TClass = UIWALS_BaseAttributeSet;
	if (!Z_Registration_Info_UClass_UIWALS_BaseAttributeSet.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("IWALS_BaseAttributeSet"),
			Z_Registration_Info_UClass_UIWALS_BaseAttributeSet.InnerSingleton,
			StaticRegisterNativesUIWALS_BaseAttributeSet,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UIWALS_BaseAttributeSet.InnerSingleton;
}
UClass* Z_Construct_UClass_UIWALS_BaseAttributeSet_NoRegister()
{
	return UIWALS_BaseAttributeSet::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UIWALS_BaseAttributeSet_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UIWALS_BaseAttributeSet_OnRep_Armor, "OnRep_Armor" }, // 861830855
		{ &Z_Construct_UFunction_UIWALS_BaseAttributeSet_OnRep_AttackMultiply, "OnRep_AttackMultiply" }, // 56108481
		{ &Z_Construct_UFunction_UIWALS_BaseAttributeSet_OnRep_Experience, "OnRep_Experience" }, // 354427264
		{ &Z_Construct_UFunction_UIWALS_BaseAttributeSet_OnRep_Health, "OnRep_Health" }, // 3515909469
	};
...
void UIWALS_BaseAttributeSet::ValidateGeneratedRepEnums(const TArray<struct FRepRecord>& ClassReps) const
{
	...
	static FName Name_AttackMultiply(TEXT("AttackMultiply"));
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_BaseAttributeSet_h__Script_IWALS_AbilitySystem_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UIWALS_BaseAttributeSet, UIWALS_BaseAttributeSet::StaticClass, TEXT("UIWALS_BaseAttributeSet"), &Z_Registration_Info_UClass_UIWALS_BaseAttributeSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIWALS_BaseAttributeSet), 3711905311U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_BaseAttributeSet_h__Script_IWALS_AbilitySystem_1671012542(TEXT("/Script/IWALS_AbilitySystem"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_BaseAttributeSet_h__Script_IWALS_AbilitySystem_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_BaseAttributeSet_h__Script_IWALS_AbilitySystem_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
