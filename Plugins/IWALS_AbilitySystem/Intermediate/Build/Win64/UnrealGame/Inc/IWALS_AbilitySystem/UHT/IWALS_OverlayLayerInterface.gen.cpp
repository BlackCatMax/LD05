...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_RequiredOverlayStateIndex_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UIWALS_OverlayLayerInterface, nullptr, "BPI_Set_RequiredOverlayStateIndex", Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_RequiredOverlayStateIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_RequiredOverlayStateIndex_Statics::PropPointers), sizeof(IWALS_OverlayLayerInterface_eventBPI_Set_RequiredOverlayStateIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_RequiredOverlayStateIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_RequiredOverlayStateIndex_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UIWALS_OverlayLayerInterface;
UClass* UIWALS_OverlayLayerInterface::GetPrivateStaticClass()
{
	using TClass = UIWALS_OverlayLayerInterface;
	if (!Z_Registration_Info_UClass_UIWALS_OverlayLayerInterface.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("IWALS_OverlayLayerInterface"),
			Z_Registration_Info_UClass_UIWALS_OverlayLayerInterface.InnerSingleton,
			StaticRegisterNativesUIWALS_OverlayLayerInterface,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UIWALS_OverlayLayerInterface.InnerSingleton;
}
UClass* Z_Construct_UClass_UIWALS_OverlayLayerInterface_NoRegister()
{
	return UIWALS_OverlayLayerInterface::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UIWALS_OverlayLayerInterface_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Get_OnUnequipFinished, "BPI_Get_OnUnequipFinished" }, // 4034651216
		{ &Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Get_OverlayHaveBlendOutState, "BPI_Get_OverlayHaveBlendOutState" }, // 2482120552
		{ &Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_OnOverlayStateChangeInit, "BPI_Set_OnOverlayStateChangeInit" }, // 1419711244
		{ &Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_OverlayHaveBlendOutState, "BPI_Set_OverlayHaveBlendOutState" }, // 527774965
		{ &Z_Construct_UFunction_UIWALS_OverlayLayerInterface_BPI_Set_RequiredOverlayStateIndex, "BPI_Set_RequiredOverlayStateIndex" }, // 1951214110
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_OverlayLayerInterface_h__Script_IWALS_AbilitySystem_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_OverlayLayerInterface_h__Script_IWALS_AbilitySystem_2918148981(TEXT("/Script/IWALS_AbilitySystem"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_OverlayLayerInterface_h__Script_IWALS_AbilitySystem_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_OverlayLayerInterface_h__Script_IWALS_AbilitySystem_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
