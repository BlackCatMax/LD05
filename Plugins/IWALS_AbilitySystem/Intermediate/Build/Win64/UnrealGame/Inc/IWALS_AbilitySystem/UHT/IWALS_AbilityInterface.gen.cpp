...
FClassRegistrationInfo Z_Registration_Info_UClass_UIWALS_AbilityInterface;
UClass* UIWALS_AbilityInterface::GetPrivateStaticClass()
{
	using TClass = UIWALS_AbilityInterface;
	if (!Z_Registration_Info_UClass_UIWALS_AbilityInterface.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("IWALS_AbilityInterface"),
			Z_Registration_Info_UClass_UIWALS_AbilityInterface.InnerSingleton,
			StaticRegisterNativesUIWALS_AbilityInterface,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UIWALS_AbilityInterface.InnerSingleton;
}
UClass* Z_Construct_UClass_UIWALS_AbilityInterface_NoRegister()
{
	return UIWALS_AbilityInterface::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UIWALS_AbilityInterface_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UIWALS_AbilityInterface_GASBPI_CallToCurrentActivatedAbility, "GASBPI_CallToCurrentActivatedAbility" }, // 3269194805
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h__Script_IWALS_AbilitySystem_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UIWALS_AbilityInterface, UIWALS_AbilityInterface::StaticClass, TEXT("UIWALS_AbilityInterface"), &Z_Registration_Info_UClass_UIWALS_AbilityInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIWALS_AbilityInterface), 1262191326U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h__Script_IWALS_AbilitySystem_1492415478(TEXT("/Script/IWALS_AbilitySystem"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h__Script_IWALS_AbilitySystem_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h__Script_IWALS_AbilitySystem_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
