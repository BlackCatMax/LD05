...
FClassRegistrationInfo Z_Registration_Info_UClass_UAGLS_CharacterMovementComponent;
UClass* UAGLS_CharacterMovementComponent::GetPrivateStaticClass()
{
	using TClass = UAGLS_CharacterMovementComponent;
	if (!Z_Registration_Info_UClass_UAGLS_CharacterMovementComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AGLS_CharacterMovementComponent"),
			Z_Registration_Info_UClass_UAGLS_CharacterMovementComponent.InnerSingleton,
			StaticRegisterNativesUAGLS_CharacterMovementComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAGLS_CharacterMovementComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UAGLS_CharacterMovementComponent_NoRegister()
{
	return UAGLS_CharacterMovementComponent::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_CharacterMovementComponent_h__Script_HelpfulFunctions_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAGLS_CharacterMovementComponent, UAGLS_CharacterMovementComponent::StaticClass, TEXT("UAGLS_CharacterMovementComponent"), &Z_Registration_Info_UClass_UAGLS_CharacterMovementComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAGLS_CharacterMovementComponent), 2766591660U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_CharacterMovementComponent_h__Script_HelpfulFunctions_3567842070(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_CharacterMovementComponent_h__Script_HelpfulFunctions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_CharacterMovementComponent_h__Script_HelpfulFunctions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
