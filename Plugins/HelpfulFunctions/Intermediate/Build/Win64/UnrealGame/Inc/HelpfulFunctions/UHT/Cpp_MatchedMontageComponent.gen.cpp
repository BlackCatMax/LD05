...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMatchedMontageTwoPoints;
class UScriptStruct* FMatchedMontageTwoPoints::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMatchedMontageTwoPoints.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMatchedMontageTwoPoints.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMatchedMontageTwoPoints, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("MatchedMontageTwoPoints"));
	}
	return Z_Registration_Info_UScriptStruct_FMatchedMontageTwoPoints.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FMatchedMontageTwoPoints.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMatchedMontageTwoPoints.InnerSingleton, Z_Construct_UScriptStruct_FMatchedMontageTwoPoints_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FMatchedMontageTwoPoints.InnerSingleton;
}
// ********** End ScriptStruct FMatchedMontageTwoPoints ********************************************

// ********** Begin ScriptStruct FMatchedMontageManyPoints *****************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints;
class UScriptStruct* FMatchedMontageManyPoints::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMatchedMontageManyPoints, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("MatchedMontageManyPoints"));
	}
	return Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints.InnerSingleton, Z_Construct_UScriptStruct_FMatchedMontageManyPoints_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints.InnerSingleton;
}
// ********** End ScriptStruct FMatchedMontageManyPoints *******************************************

// ********** Begin ScriptStruct FMMEndingEvent ****************************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMMEndingEvent;
class UScriptStruct* FMMEndingEvent::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMMEndingEvent.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMMEndingEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMMEndingEvent, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("MMEndingEvent"));
	}
	return Z_Registration_Info_UScriptStruct_FMMEndingEvent.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FMMEndingEvent.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMMEndingEvent.InnerSingleton, Z_Construct_UScriptStruct_FMMEndingEvent_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FMMEndingEvent.InnerSingleton;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCpp_MatchedMontageComponent_MatchingMultiplePointsC_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCpp_MatchedMontageComponent, nullptr, "MatchingMultiplePointsC", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCpp_MatchedMontageComponent_MatchingMultiplePointsC_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCpp_MatchedMontageComponent_MatchingMultiplePointsC_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCpp_MatchedMontageComponent_PlayMatchedMontageManyPointsC_Statics::NewProp_ConfigStruct = { "ConfigStruct", nullptr, (EPropertyFlags)0x0010008000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Cpp_MatchedMontageComponent_eventPlayMatchedMontageManyPointsC_Parms, ConfigStruct), Z_Construct_UScriptStruct_FMatchedMontageManyPoints, METADATA_PARAMS(0, nullptr) }; // 2711341459
...
FClassRegistrationInfo Z_Registration_Info_UClass_UCpp_MatchedMontageComponent;
UClass* UCpp_MatchedMontageComponent::GetPrivateStaticClass()
{
	using TClass = UCpp_MatchedMontageComponent;
	if (!Z_Registration_Info_UClass_UCpp_MatchedMontageComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("Cpp_MatchedMontageComponent"),
			Z_Registration_Info_UClass_UCpp_MatchedMontageComponent.InnerSingleton,
			StaticRegisterNativesUCpp_MatchedMontageComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UCpp_MatchedMontageComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UCpp_MatchedMontageComponent_NoRegister()
{
	return UCpp_MatchedMontageComponent::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UCpp_MatchedMontageComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_ExtractedInterpolationC, "ExtractedInterpolationC" }, // 291456512
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_FinishMatchedMontageC, "FinishMatchedMontageC" }, // 691162122
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_GetAnimCurveC, "GetAnimCurveC" }, // 3846898376
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_GetCustomCurveValueC, "GetCustomCurveValueC" }, // 428635522
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_MatchingMotionNormalized, "MatchingMotionNormalized" }, // 126132506
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_MatchingMultiplePointsC, "MatchingMultiplePointsC" }, // 1076496360
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_MatchingSinglePointsC, "MatchingSinglePointsC" }, // 1590772000
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_PlayMatchedMontageManyPointsC, "PlayMatchedMontageManyPointsC" }, // 2365909740
		{ &Z_Construct_UFunction_UCpp_MatchedMontageComponent_PlayMatchedMontageTwoPointsC, "PlayMatchedMontageTwoPointsC" }, // 3766289845
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_MatchedMontageComponent_h__Script_HelpfulFunctions_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FMatchedMontageManyPoints::StaticStruct, Z_Construct_UScriptStruct_FMatchedMontageManyPoints_Statics::NewStructOps, TEXT("MatchedMontageManyPoints"), &Z_Registration_Info_UScriptStruct_FMatchedMontageManyPoints, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMatchedMontageManyPoints), 2711341459U) },
		{ FMMEndingEvent::StaticStruct, Z_Construct_UScriptStruct_FMMEndingEvent_Statics::NewStructOps, TEXT("MMEndingEvent"), &Z_Registration_Info_UScriptStruct_FMMEndingEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMMEndingEvent), 2272812094U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_MatchedMontageComponent_h__Script_HelpfulFunctions_1480820481(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_MatchedMontageComponent_h__Script_HelpfulFunctions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_MatchedMontageComponent_h__Script_HelpfulFunctions_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_MatchedMontageComponent_h__Script_HelpfulFunctions_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_MatchedMontageComponent_h__Script_HelpfulFunctions_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
