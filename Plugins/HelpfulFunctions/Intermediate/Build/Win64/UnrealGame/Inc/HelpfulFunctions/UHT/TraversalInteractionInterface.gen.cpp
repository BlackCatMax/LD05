...
FClassRegistrationInfo Z_Registration_Info_UClass_UTraversalInteractionInterface;
UClass* UTraversalInteractionInterface::GetPrivateStaticClass()
{
	using TClass = UTraversalInteractionInterface;
	if (!Z_Registration_Info_UClass_UTraversalInteractionInterface.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("TraversalInteractionInterface"),
			Z_Registration_Info_UClass_UTraversalInteractionInterface.InnerSingleton,
			StaticRegisterNativesUTraversalInteractionInterface,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UTraversalInteractionInterface.InnerSingleton;
}
UClass* Z_Construct_UClass_UTraversalInteractionInterface_NoRegister()
{
	return UTraversalInteractionInterface::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UTraversalInteractionInterface_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Get_ControlTransform, "BPI_Get_ControlTransform" }, // 3287820224
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Get_InteractionTransform, "BPI_Get_InteractionTransform" }, // 3278817831
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Get_RootTransform, "BPI_Get_RootTransform" }, // 827497942
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Get_StartedPredictableJump, "BPI_Get_StartedPredictableJump" }, // 4024024719
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Get_StartedTraversalAction, "BPI_Get_StartedTraversalAction" }, // 3019452496
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Set_InteractionTransform, "BPI_Set_InteractionTransform" }, // 1676904139
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Set_PredictableJump, "BPI_Set_PredictableJump" }, // 3287017988
		{ &Z_Construct_UFunction_UTraversalInteractionInterface_BPI_Set_TraversalAction, "BPI_Set_TraversalAction" }, // 3211881913
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_TraversalInteractionInterface_h__Script_HelpfulFunctions_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTraversalInteractionInterface, UTraversalInteractionInterface::StaticClass, TEXT("UTraversalInteractionInterface"), &Z_Registration_Info_UClass_UTraversalInteractionInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTraversalInteractionInterface), 783900280U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_TraversalInteractionInterface_h__Script_HelpfulFunctions_1644898325(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_TraversalInteractionInterface_h__Script_HelpfulFunctions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_TraversalInteractionInterface_h__Script_HelpfulFunctions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
