...
// ********** Begin Class AAGLS_HumanAI_CharacterBase Function CalculateCustomCharacterRotation ****
static FName NAME_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation = FName(TEXT("CalculateCustomCharacterRotation"));
void AAGLS_HumanAI_CharacterBase::CalculateCustomCharacterRotation()
{
	UFunction* Func = FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
...
struct Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Human AI|Essential" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//AGLS v1.6  09.09.2025\n" },
#endif
		{ "DisplayName", "Calculate Custom Character Rotation" },
		{ "ForceAsFunction", "" },
		{ "Keywords", "AGLS Character" },
		{ "ModuleRelativePath", "Public/AGLS_HumanAI_CharacterBase.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "AGLS v1.6  09.09.2025" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, nullptr, "CalculateCustomCharacterRotation", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C080C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AAGLS_HumanAI_CharacterBase::execCalculateCustomCharacterRotation)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->CalculateCustomCharacterRotation_Implementation();
	P_NATIVE_END;
}
// ********** End Class AAGLS_HumanAI_CharacterBase Function CalculateCustomCharacterRotation ******
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ChangeToPistolWhenNoAmmo_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, nullptr, "ChangeToPistolWhenNoAmmo", Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ChangeToPistolWhenNoAmmo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ChangeToPistolWhenNoAmmo_Statics::PropPointers), sizeof(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ChangeToPistolWhenNoAmmo_Statics::AGLS_HumanAI_CharacterBase_eventChangeToPistolWhenNoAmmo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ChangeToPistolWhenNoAmmo_Statics::Function_MetaDataParams), Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ChangeToPistolWhenNoAmmo_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CheckFallDamage_Statics::NewProp_LandHitResult = { "LandHitResult", nullptr, (EPropertyFlags)0x0010008000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGLS_HumanAI_CharacterBase_eventCheckFallDamage_Parms, LandHitResult), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(0, nullptr) }; // 267591329
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_DeathByFallDamage_Statics::NewProp_HitGroundResult = { "HitGroundResult", nullptr, (EPropertyFlags)0x0010008000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGLS_HumanAI_CharacterBase_eventDeathByFallDamage_Parms, HitGroundResult), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(0, nullptr) }; // 267591329
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, nullptr, "GetGetUpAnimation", Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation_Statics::PropPointers), sizeof(AGLS_HumanAI_CharacterBase_eventGetGetUpAnimation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x1C080C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, nullptr, "GetPistolAmmoData", Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData_Statics::PropPointers), sizeof(AGLS_HumanAI_CharacterBase_eventGetPistolAmmoData_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x1C480C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData_Statics::Function_MetaDataParams), Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData_Statics::Function_MetaDataParams)},  };
...
static FName NAME_AAGLS_HumanAI_CharacterBase_RagdollUpdate = FName(TEXT("RagdollUpdate"));
void AAGLS_HumanAI_CharacterBase::RagdollUpdate(float OutSpringRange, float InDamping, float InForceLimit, int32 DebugIndex)
{
	UFunction* Func = FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_RagdollUpdate);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		AGLS_HumanAI_CharacterBase_eventRagdollUpdate_Parms Parms;
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollUpdate_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, nullptr, "RagdollUpdate", Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollUpdate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollUpdate_Statics::PropPointers), sizeof(AGLS_HumanAI_CharacterBase_eventRagdollUpdate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C080C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollUpdate_Statics::Function_MetaDataParams), Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollUpdate_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(AGLS_HumanAI_CharacterBase_eventRagdollUpdate_Parms) < MAX_uint16);
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, nullptr, "UpdateGroundedMovementValues", Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues_Statics::PropPointers), sizeof(AGLS_HumanAI_CharacterBase_eventUpdateGroundedMovementValues_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C080C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues_Statics::Function_MetaDataParams), Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues_Statics::Function_MetaDataParams)},  };
...
void AAGLS_HumanAI_CharacterBase::StaticRegisterNativesAAGLS_HumanAI_CharacterBase()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "CalculateCustomCharacterRotation", &AAGLS_HumanAI_CharacterBase::execCalculateCustomCharacterRotation },
...
FClassRegistrationInfo Z_Registration_Info_UClass_AAGLS_HumanAI_CharacterBase;
UClass* AAGLS_HumanAI_CharacterBase::GetPrivateStaticClass()
{
	using TClass = AAGLS_HumanAI_CharacterBase;
	if (!Z_Registration_Info_UClass_AAGLS_HumanAI_CharacterBase.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AGLS_HumanAI_CharacterBase"),
			Z_Registration_Info_UClass_AAGLS_HumanAI_CharacterBase.InnerSingleton,
			StaticRegisterNativesAAGLS_HumanAI_CharacterBase,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AAGLS_HumanAI_CharacterBase.InnerSingleton;
}
UClass* Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_NoRegister()
{
	return AAGLS_HumanAI_CharacterBase::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DontCalculateCustomRotOnVelocityMode_MetaData[] = {
		{ "AllowPrivateAccess", "True" },
		{ "Category", "Human AI|Movement" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Implemented in AGLS v1.6\n" },
#endif
		{ "ModuleRelativePath", "Public/AGLS_HumanAI_CharacterBase.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Implemented in AGLS v1.6" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_UseRotateToVelocityOnSprintGait_MetaData[] = {
		{ "AllowPrivateAccess", "True" },
		{ "Category", "Human AI|Movement" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Implemented in AGLS v1.6\n" },
	...
	static void NewProp_DontCalculateCustomRotOnVelocityMode_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_DontCalculateCustomRotOnVelocityMode;
	static void NewProp_UseRotateToVelocityOnSprintGait_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_UseRotateToVelocityOnSprintGait;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ApplyDamageValue, "ApplyDamageValue" }, // 1013175565
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_AttachAllPropsToDefault, "AttachAllPropsToDefault" }, // 974183779
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_AttachPropTo, "AttachPropTo" }, // 1779079487
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CalculateCustomCharacterRotation, "CalculateCustomCharacterRotation" }, // 3344077970
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CanUpdateOverlay, "CanUpdateOverlay" }, // 4221347435
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ChangeToPistolWhenNoAmmo, "ChangeToPistolWhenNoAmmo" }, // 2954760524
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CheckCanShoot, "CheckCanShoot" }, // 1862040041
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CheckFallDamage, "CheckFallDamage" }, // 2225860704
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_CheckHealthPerFrame, "CheckHealthPerFrame" }, // 38972450
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_DeathByFallDamage, "DeathByFallDamage" }, // 2710230418
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_DropProps, "DropProps" }, // 2970559003
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_FindCoverFast, "FindCoverFast" }, // 3899234440
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetCalpsuleBaseLocation, "GetCalpsuleBaseLocation" }, // 2763367164
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetCapsuleLocationFromBase, "GetCapsuleLocationFromBase" }, // 62486005
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetControlForwardRightVector, "GetControlForwardRightVector" }, // 3067481561
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation, "GetGetUpAnimation" }, // 1548816579
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData, "GetPistolAmmoData" }, // 1584935258
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetRifleAmmoData, "GetRifleAmmoData" }, // 4268229446
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_GetTargetSpeedWithStrafe, "GetTargetSpeedWithStrafe" }, // 389353017
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_IsAlive, "IsAlive" }, // 184446071
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_MakeForPropsAttachValues, "MakeForPropsAttachValues" }, // 1096000350
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_OnCharacterMovementModeChanged, "OnCharacterMovementModeChanged" }, // 451045795
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_OnGaitChanged, "OnGaitChanged" }, // 4277819769
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_OnMovementActionChanged, "OnMovementActionChanged" }, // 2944200907
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_OnMovementStateChanged, "OnMovementStateChanged" }, // 3618362277
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_OnOverlayStateChanged, "OnOverlayStateChanged" }, // 4160147723
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_OnRotationModeChanged, "OnRotationModeChanged" }, // 2816875884
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_OnStanceChanged, "OnStanceChanged" }, // 2779032469
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollEnd, "RagdollEnd" }, // 1169296676
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollStart, "RagdollStart" }, // 2143214173
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_RagdollUpdate, "RagdollUpdate" }, // 805580016
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_SetCurrentMovementParametersValues, "SetCurrentMovementParametersValues" }, // 4104994098
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ShotFirstTraceCheck, "ShotFirstTraceCheck" }, // 2989501228
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_ShotScanTraceCheck, "ShotScanTraceCheck" }, // 372217403
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_SmoothedCapsuleRadiusUpdate, "SmoothedCapsuleRadiusUpdate" }, // 1716420064
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_StartDyingSequence, "StartDyingSequence" }, // 900541600
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_TrySimpleTraversalAction, "TrySimpleTraversalAction" }, // 3814552915
		{ &Z_Construct_UFunction_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues, "UpdateGroundedMovementValues" }, // 2890366452
	};
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsDeathC = { "IsDeathC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsDeathC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsDeathC_MetaData), NewProp_IsDeathC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_HitedByKnifeOrHandC = { "HitedByKnifeOrHandC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_HitedByKnifeOrHandC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HitedByKnifeOrHandC_MetaData), NewProp_HitedByKnifeOrHandC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsEquipPropC = { "IsEquipPropC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsEquipPropC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsEquipPropC_MetaData), NewProp_IsEquipPropC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsReloadingWeaponC = { "IsReloadingWeaponC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsReloadingWeaponC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsReloadingWeaponC_MetaData), NewProp_IsReloadingWeaponC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsHostageC = { "IsHostageC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsHostageC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsHostageC_MetaData), NewProp_IsHostageC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsVicForSF = { "IsVicForSF", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsVicForSF_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsVicForSF_MetaData), NewProp_IsVicForSF_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_StartStealthKillC = { "StartStealthKillC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_StartStealthKillC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StartStealthKillC_MetaData), NewProp_StartStealthKillC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsSittingC = { "IsSittingC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsSittingC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsSittingC_MetaData), NewProp_IsSittingC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_CanUpdateRotationMode = { "CanUpdateRotationMode", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_CanUpdateRotationMode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CanUpdateRotationMode_MetaData), NewProp_CanUpdateRotationMode_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_LODsUp = { "LODsUp", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_LODsUp_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LODsUp_MetaData), NewProp_LODsUp_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_BreakFall = { "BreakFall", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_BreakFall_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BreakFall_MetaData), NewProp_BreakFall_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_TargetAiming = { "TargetAiming", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, TargetAiming), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TargetAiming_MetaData), NewProp_TargetAiming_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_CurrentHealthPoints = { "CurrentHealthPoints", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, CurrentHealthPoints), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurrentHealthPoints_MetaData), NewProp_CurrentHealthPoints_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_SpeedScaleC = { "SpeedScaleC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, SpeedScaleC), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SpeedScaleC_MetaData), NewProp_SpeedScaleC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_RagdollOnGround = { "RagdollOnGround", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_RagdollOnGround_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RagdollOnGround_MetaData), NewProp_RagdollOnGround_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_RagdollFaceUp = { "RagdollFaceUp", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_RagdollFaceUp_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RagdollFaceUp_MetaData), NewProp_RagdollFaceUp_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_LastRagdollVelocity = { "LastRagdollVelocity", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, LastRagdollVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LastRagdollVelocity_MetaData), NewProp_LastRagdollVelocity_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DeathTime = { "DeathTime", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DeathTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DeathTime_MetaData), NewProp_DeathTime_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_RagdollGetUpAnim = { "RagdollGetUpAnim", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, RagdollGetUpAnim), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RagdollGetUpAnim_MetaData), NewProp_RagdollGetUpAnim_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_HaveRifle = { "HaveRifle", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_HaveRifle_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HaveRifle_MetaData), NewProp_HaveRifle_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_HavePistol = { "HavePistol", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_HavePistol_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HavePistol_MetaData), NewProp_HavePistol_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_CanShoot = { "CanShoot", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_CanShoot_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CanShoot_MetaData), NewProp_CanShoot_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DealingDamageScalar = { "DealingDamageScalar", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DealingDamageScalar), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DealingDamageScalar_MetaData), NewProp_DealingDamageScalar_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DispersionOffset = { "DispersionOffset", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DispersionOffset), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DispersionOffset_MetaData), NewProp_DispersionOffset_MetaData) };
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_PrevMovementStateC = { "PrevMovementStateC", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, PrevMovementStateC), Z_Construct_UEnum_HelpfulFunctions_CALS_MovementState, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PrevMovementStateC_MetaData), NewProp_PrevMovementStateC_MetaData) }; // 3255268152
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DesiredRotationModeC = { "DesiredRotationModeC", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DesiredRotationModeC), Z_Construct_UEnum_HelpfulFunctions_CALS_RotationMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DesiredRotationModeC_MetaData), NewProp_DesiredRotationModeC_MetaData) }; // 1340769226
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DesiredStanceC = { "DesiredStanceC", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DesiredStanceC), Z_Construct_UEnum_HelpfulFunctions_CALS_Stance, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DesiredStanceC_MetaData), NewProp_DesiredStanceC_MetaData) }; // 87690985
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_PrevOverlayState = { "PrevOverlayState", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, PrevOverlayState), Z_Construct_UEnum_HelpfulFunctions_CALS_OverlayState, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PrevOverlayState_MetaData), NewProp_PrevOverlayState_MetaData) }; // 3098219672
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_GroundedMoveModeC = { "GroundedMoveModeC", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, GroundedMoveModeC), Z_Construct_UEnum_HelpfulFunctions_CALS_GroundedMoveMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GroundedMoveModeC_MetaData), NewProp_GroundedMoveModeC_MetaData) }; // 1562728553
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_LOD_State = { "LOD_State", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, LOD_State), Z_Construct_UEnum_HelpfulFunctions_AGLS_LOD_State, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LOD_State_MetaData), NewProp_LOD_State_MetaData) }; // 270714742
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DefCapsuleSizeC = { "DefCapsuleSizeC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DefCapsuleSizeC), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefCapsuleSizeC_MetaData), NewProp_DefCapsuleSizeC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsPlayingPushAnimationC = { "IsPlayingPushAnimationC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsPlayingPushAnimationC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsPlayingPushAnimationC_MetaData), NewProp_IsPlayingPushAnimationC_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsPlayingHitByZombieMontageC = { "IsPlayingHitByZombieMontageC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_IsPlayingHitByZombieMontageC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsPlayingHitByZombieMontageC_MetaData), NewProp_IsPlayingHitByZombieMontageC_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_PreviousVelocityC = { "PreviousVelocityC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, PreviousVelocityC), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PreviousVelocityC_MetaData), NewProp_PreviousVelocityC_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_PreviousAimYawC = { "PreviousAimYawC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, PreviousAimYawC), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PreviousAimYawC_MetaData), NewProp_PreviousAimYawC_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DyingMontageC = { "DyingMontageC", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DyingMontageC), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DyingMontageC_MetaData), NewProp_DyingMontageC_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_HostageAtt = { "HostageAtt", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, HostageAtt), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HostageAtt_MetaData), NewProp_HostageAtt_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_PropsAttachValues_ValueProp = { "PropsAttachValues", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FCALS_PropsAttachValues, METADATA_PARAMS(0, nullptr) }; // 3752124143
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_PropsAttachValues = { "PropsAttachValues", nullptr, (EPropertyFlags)0x0010008000000004, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, PropsAttachValues), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PropsAttachValues_MetaData), NewProp_PropsAttachValues_MetaData) }; // 3098219672 3752124143
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_CurrentHoldingProp = { "CurrentHoldingProp", nullptr, (EPropertyFlags)0x001000000008000c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, CurrentHoldingProp), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurrentHoldingProp_MetaData), NewProp_CurrentHoldingProp_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_RotateCapsuleToControlInIdle = { "RotateCapsuleToControlInIdle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_RotateCapsuleToControlInIdle_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RotateCapsuleToControlInIdle_MetaData), NewProp_RotateCapsuleToControlInIdle_MetaData) };
void Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DontCalculateCustomRotOnVelocityMode_SetBit(void* Obj)
{
	((AAGLS_HumanAI_CharacterBase*)Obj)->DontCalculateCustomRotOnVelocityMode = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DontCalculateCustomRotOnVelocityMode = { "DontCalculateCustomRotOnVelocityMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DontCalculateCustomRotOnVelocityMode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DontCalculateCustomRotOnVelocityMode_MetaData), NewProp_DontCalculateCustomRotOnVelocityMode_MetaData) };
void Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_UseRotateToVelocityOnSprintGait_SetBit(void* Obj)
{
	((AAGLS_HumanAI_CharacterBase*)Obj)->UseRotateToVelocityOnSprintGait = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_UseRotateToVelocityOnSprintGait = { "UseRotateToVelocityOnSprintGait", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAGLS_HumanAI_CharacterBase), &Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_UseRotateToVelocityOnSprintGait_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_UseRotateToVelocityOnSprintGait_MetaData), NewProp_UseRotateToVelocityOnSprintGait_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_CapsuleRotationRateInIdle = { "CapsuleRotationRateInIdle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, CapsuleRotationRateInIdle), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CapsuleRotationRateInIdle_MetaData), NewProp_CapsuleRotationRateInIdle_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DecelerationBiasScale = { "DecelerationBiasScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, DecelerationBiasScale), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DecelerationBiasScale_MetaData), NewProp_DecelerationBiasScale_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_GroundFrictionBiasScale = { "GroundFrictionBiasScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAGLS_HumanAI_CharacterBase, GroundFrictionBiasScale), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GroundFrictionBiasScale_MetaData), NewProp_GroundFrictionBiasScale_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_DontCalculateCustomRotOnVelocityMode,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::NewProp_UseRotateToVelocityOnSprintGait,
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UAGLS_AI_HumanCharInterface_NoRegister, (int32)VTABLE_OFFSET(AAGLS_HumanAI_CharacterBase, IAGLS_AI_HumanCharInterface), false },  // 4189334401
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h__Script_HelpfulFunctions_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, AAGLS_HumanAI_CharacterBase::StaticClass, TEXT("AAGLS_HumanAI_CharacterBase"), &Z_Registration_Info_UClass_AAGLS_HumanAI_CharacterBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAGLS_HumanAI_CharacterBase), 3304615916U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h__Script_HelpfulFunctions_1599695784(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h__Script_HelpfulFunctions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h__Script_HelpfulFunctions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
