...
static FEnumRegistrationInfo Z_Registration_Info_UEnum_AGLS_HumanAI_MainBehaviorMode;
static UEnum* AGLS_HumanAI_MainBehaviorMode_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_MainBehaviorMode.OuterSingleton)
	{
		Z_Registration_Info_UEnum_AGLS_HumanAI_MainBehaviorMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("AGLS_HumanAI_MainBehaviorMode"));
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_MainBehaviorMode.OuterSingleton;
}
template<> HELPFULFUNCTIONS_API UEnum* StaticEnum<AGLS_HumanAI_MainBehaviorMode>()
{
	return AGLS_HumanAI_MainBehaviorMode_StaticEnum();
}
struct Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode_Statics
{
#if WITH_METADATA
...
#endif
		{ "Fighting.Comment", "/**\n * \n */" },
		{ "Fighting.Name", "AGLS_HumanAI_MainBehaviorMode::Fighting" },
		{ "Finding.Comment", "/**\n * \n */" },
		{ "Finding.Name", "AGLS_HumanAI_MainBehaviorMode::Finding" },
		{ "Interacting.Comment", "/**\n * \n */" },
		{ "Interacting.Name", "AGLS_HumanAI_MainBehaviorMode::Interacting" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
		{ "None.Comment", "/**\n * \n */" },
		{ "None.Name", "AGLS_HumanAI_MainBehaviorMode::None" },
		{ "Patroling.Comment", "/**\n * \n */" },
		{ "Patroling.Name", "AGLS_HumanAI_MainBehaviorMode::Patroling" },
		{ "Running.Comment", "/**\n * \n */" },
		{ "Running.Name", "AGLS_HumanAI_MainBehaviorMode::Running" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "AGLS_HumanAI_MainBehaviorMode::Patroling", (int64)AGLS_HumanAI_MainBehaviorMode::Patroling },
		{ "AGLS_HumanAI_MainBehaviorMode::Finding", (int64)AGLS_HumanAI_MainBehaviorMode::Finding },
		{ "AGLS_HumanAI_MainBehaviorMode::Fighting", (int64)AGLS_HumanAI_MainBehaviorMode::Fighting },
		{ "AGLS_HumanAI_MainBehaviorMode::Running", (int64)AGLS_HumanAI_MainBehaviorMode::Running },
		{ "AGLS_HumanAI_MainBehaviorMode::Interacting", (int64)AGLS_HumanAI_MainBehaviorMode::Interacting },
		{ "AGLS_HumanAI_MainBehaviorMode::None", (int64)AGLS_HumanAI_MainBehaviorMode::None },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_HelpfulFunctions,
	nullptr,
	"AGLS_HumanAI_MainBehaviorMode",
	"AGLS_HumanAI_MainBehaviorMode",
	Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_MainBehaviorMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_AGLS_HumanAI_MainBehaviorMode.InnerSingleton, Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_MainBehaviorMode_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_MainBehaviorMode.InnerSingleton;
}
// ********** End Enum AGLS_HumanAI_MainBehaviorMode ***********************************************

// ********** Begin Enum AGLS_HumanAI_PatrolingMode ************************************************
static FEnumRegistrationInfo Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode;
static UEnum* AGLS_HumanAI_PatrolingMode_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode.OuterSingleton)
	{
		Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("AGLS_HumanAI_PatrolingMode"));
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode.OuterSingleton;
}
template<> HELPFULFUNCTIONS_API UEnum* StaticEnum<AGLS_HumanAI_PatrolingMode>()
{
	return AGLS_HumanAI_PatrolingMode_StaticEnum();
}
struct Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "FollowingPath.Name", "AGLS_HumanAI_PatrolingMode::FollowingPath" },
		{ "Interacting.Name", "AGLS_HumanAI_PatrolingMode::Interacting" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
		{ "NoMoveAndSit.Name", "AGLS_HumanAI_PatrolingMode::NoMoveAndSit" },
		{ "NoMoveAndStand.Name", "AGLS_HumanAI_PatrolingMode::NoMoveAndStand" },
		{ "None.Name", "AGLS_HumanAI_PatrolingMode::None" },
		{ "RandomMove.Name", "AGLS_HumanAI_PatrolingMode::RandomMove" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "AGLS_HumanAI_PatrolingMode::FollowingPath", (int64)AGLS_HumanAI_PatrolingMode::FollowingPath },
		{ "AGLS_HumanAI_PatrolingMode::RandomMove", (int64)AGLS_HumanAI_PatrolingMode::RandomMove },
		{ "AGLS_HumanAI_PatrolingMode::NoMoveAndStand", (int64)AGLS_HumanAI_PatrolingMode::NoMoveAndStand },
		{ "AGLS_HumanAI_PatrolingMode::NoMoveAndSit", (int64)AGLS_HumanAI_PatrolingMode::NoMoveAndSit },
		{ "AGLS_HumanAI_PatrolingMode::Interacting", (int64)AGLS_HumanAI_PatrolingMode::Interacting },
		{ "AGLS_HumanAI_PatrolingMode::None", (int64)AGLS_HumanAI_PatrolingMode::None },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_HelpfulFunctions,
	nullptr,
	"AGLS_HumanAI_PatrolingMode",
	"AGLS_HumanAI_PatrolingMode",
	Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode.InnerSingleton, Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_PatrolingMode_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode.InnerSingleton;
}
// ********** End Enum AGLS_HumanAI_PatrolingMode **************************************************

// ********** Begin Enum AGLS_HumanAI_FightingMode *************************************************
static FEnumRegistrationInfo Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode;
static UEnum* AGLS_HumanAI_FightingMode_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode.OuterSingleton)
	{
		Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("AGLS_HumanAI_FightingMode"));
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode.OuterSingleton;
}
template<> HELPFULFUNCTIONS_API UEnum* StaticEnum<AGLS_HumanAI_FightingMode>()
{
	return AGLS_HumanAI_FightingMode_StaticEnum();
}
struct Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "FullAgressive.Name", "AGLS_HumanAI_FightingMode::FullAgressive" },
		{ "HideBehindCover.Name", "AGLS_HumanAI_FightingMode::HideBehindCover" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
		{ "NoCovering.Name", "AGLS_HumanAI_FightingMode::NoCovering" },
		{ "None.Name", "AGLS_HumanAI_FightingMode::None" },
		{ "RunningFromEnemy.Name", "AGLS_HumanAI_FightingMode::RunningFromEnemy" },
		{ "SearchingForEnemy.Name", "AGLS_HumanAI_FightingMode::SearchingForEnemy" },
		{ "WithoutWeapons.Name", "AGLS_HumanAI_FightingMode::WithoutWeapons" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "AGLS_HumanAI_FightingMode::HideBehindCover", (int64)AGLS_HumanAI_FightingMode::HideBehindCover },
		{ "AGLS_HumanAI_FightingMode::NoCovering", (int64)AGLS_HumanAI_FightingMode::NoCovering },
		{ "AGLS_HumanAI_FightingMode::RunningFromEnemy", (int64)AGLS_HumanAI_FightingMode::RunningFromEnemy },
		{ "AGLS_HumanAI_FightingMode::SearchingForEnemy", (int64)AGLS_HumanAI_FightingMode::SearchingForEnemy },
		{ "AGLS_HumanAI_FightingMode::WithoutWeapons", (int64)AGLS_HumanAI_FightingMode::WithoutWeapons },
		{ "AGLS_HumanAI_FightingMode::FullAgressive", (int64)AGLS_HumanAI_FightingMode::FullAgressive },
		{ "AGLS_HumanAI_FightingMode::None", (int64)AGLS_HumanAI_FightingMode::None },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_HelpfulFunctions,
	nullptr,
	"AGLS_HumanAI_FightingMode",
	"AGLS_HumanAI_FightingMode",
	Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode.InnerSingleton, Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_FightingMode_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode.InnerSingleton;
}
// ********** End Enum AGLS_HumanAI_FightingMode ***************************************************

// ********** Begin Enum AGLS_HumanAI_SightStatus **************************************************
static FEnumRegistrationInfo Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus;
static UEnum* AGLS_HumanAI_SightStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("AGLS_HumanAI_SightStatus"));
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus.OuterSingleton;
}
template<> HELPFULFUNCTIONS_API UEnum* StaticEnum<AGLS_HumanAI_SightStatus>()
{
	return AGLS_HumanAI_SightStatus_StaticEnum();
}
struct Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "ActiveSeeEnemy.Name", "AGLS_HumanAI_SightStatus::ActiveSeeEnemy" },
		{ "BlueprintType", "true" },
		{ "LostSight.Name", "AGLS_HumanAI_SightStatus::LostSight" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
		{ "NotAnymoreSee.Name", "AGLS_HumanAI_SightStatus::NotAnymoreSee" },
		{ "SawSomething.Name", "AGLS_HumanAI_SightStatus::SawSomething" },
		{ "SeesNothing.Name", "AGLS_HumanAI_SightStatus::SeesNothing" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "AGLS_HumanAI_SightStatus::SeesNothing", (int64)AGLS_HumanAI_SightStatus::SeesNothing },
		{ "AGLS_HumanAI_SightStatus::SawSomething", (int64)AGLS_HumanAI_SightStatus::SawSomething },
		{ "AGLS_HumanAI_SightStatus::ActiveSeeEnemy", (int64)AGLS_HumanAI_SightStatus::ActiveSeeEnemy },
		{ "AGLS_HumanAI_SightStatus::LostSight", (int64)AGLS_HumanAI_SightStatus::LostSight },
		{ "AGLS_HumanAI_SightStatus::NotAnymoreSee", (int64)AGLS_HumanAI_SightStatus::NotAnymoreSee },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_HelpfulFunctions,
	nullptr,
	"AGLS_HumanAI_SightStatus",
	"AGLS_HumanAI_SightStatus",
	Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus()
{
	if (!Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus.InnerSingleton, Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus.InnerSingleton;
}
...
static_assert(std::is_polymorphic<FAGLS_HumanAI_EnemyTags>() == std::is_polymorphic<FTableRowBase>(), "USTRUCT FAGLS_HumanAI_EnemyTags cannot be polymorphic unless super FTableRowBase is polymorphic");
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags;
class UScriptStruct* FAGLS_HumanAI_EnemyTags::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("AGLS_HumanAI_EnemyTags"));
	}
	return Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags.OuterSingleton;
}
struct Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics
{
#if WITH_METADATA
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DetectedEnemy_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SightStatus_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ReactionProgressTime_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LostSightLocation_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_IsZombie_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_EnemySpottedHim_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ShouldHideSelfFromEnemy_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PiorityBias_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ChanceForFinisher_MetaData[] = {
		{ "Category", "Sight Perception" },
		{ "ModuleRelativePath", "Public/ALS_StructuresAndEnumsCpp.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FBytePropertyParams NewProp_SightStatus_Underlying;
	static const UECodeGen_Private::FEnumPropertyParams NewProp_SightStatus;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_EnemyCharacter;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_ReactionProgressTime;
	static const UECodeGen_Private::FStructPropertyParams NewProp_LostSightLocation;
	...
	static void NewProp_ShouldHideSelfFromEnemy_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ShouldHideSelfFromEnemy;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_PiorityBias;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_ChanceForFinisher;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static void* NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FAGLS_HumanAI_EnemyTags>();
	}
	static const UECodeGen_Private::FStructParams StructParams;
};
void Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_DetectedEnemy_SetBit(void* Obj)
{
	((FAGLS_HumanAI_EnemyTags*)Obj)->DetectedEnemy = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_DetectedEnemy = { "DetectedEnemy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAGLS_HumanAI_EnemyTags), &Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_DetectedEnemy_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DetectedEnemy_MetaData), NewProp_DetectedEnemy_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_SightStatus_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_SightStatus = { "SightStatus", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAGLS_HumanAI_EnemyTags, SightStatus), Z_Construct_UEnum_HelpfulFunctions_AGLS_HumanAI_SightStatus, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SightStatus_MetaData), NewProp_SightStatus_MetaData) }; // 2873589976
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_EnemyCharacter = { "EnemyCharacter", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAGLS_HumanAI_EnemyTags, EnemyCharacter), Z_Construct_UClass_ACharacter_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EnemyCharacter_MetaData), NewProp_EnemyCharacter_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ReactionProgressTime = { "ReactionProgressTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAGLS_HumanAI_EnemyTags, ReactionProgressTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReactionProgressTime_MetaData), NewProp_ReactionProgressTime_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_LostSightLocation = { "LostSightLocation", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAGLS_HumanAI_EnemyTags, LostSightLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LostSightLocation_MetaData), NewProp_LostSightLocation_MetaData) };
void Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_IsZombie_SetBit(void* Obj)
{
	((FAGLS_HumanAI_EnemyTags*)Obj)->IsZombie = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_IsZombie = { "IsZombie", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAGLS_HumanAI_EnemyTags), &Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_IsZombie_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsZombie_MetaData), NewProp_IsZombie_MetaData) };
void Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_EnemySpottedHim_SetBit(void* Obj)
{
	((FAGLS_HumanAI_EnemyTags*)Obj)->EnemySpottedHim = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_EnemySpottedHim = { "EnemySpottedHim", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAGLS_HumanAI_EnemyTags), &Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_EnemySpottedHim_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EnemySpottedHim_MetaData), NewProp_EnemySpottedHim_MetaData) };
void Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ShouldHideSelfFromEnemy_SetBit(void* Obj)
{
	((FAGLS_HumanAI_EnemyTags*)Obj)->ShouldHideSelfFromEnemy = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ShouldHideSelfFromEnemy = { "ShouldHideSelfFromEnemy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAGLS_HumanAI_EnemyTags), &Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ShouldHideSelfFromEnemy_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ShouldHideSelfFromEnemy_MetaData), NewProp_ShouldHideSelfFromEnemy_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_PiorityBias = { "PiorityBias", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAGLS_HumanAI_EnemyTags, PiorityBias), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PiorityBias_MetaData), NewProp_PiorityBias_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ChanceForFinisher = { "ChanceForFinisher", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAGLS_HumanAI_EnemyTags, ChanceForFinisher), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ChanceForFinisher_MetaData), NewProp_ChanceForFinisher_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_DetectedEnemy,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_SightStatus_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_SightStatus,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_EnemyCharacter,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ReactionProgressTime,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_LostSightLocation,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_IsZombie,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_EnemySpottedHim,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ShouldHideSelfFromEnemy,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_PiorityBias,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewProp_ChanceForFinisher,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_HelpfulFunctions,
	Z_Construct_UScriptStruct_FTableRowBase,
	&NewStructOps,
	"AGLS_HumanAI_EnemyTags",
	Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::PropPointers),
	sizeof(FAGLS_HumanAI_EnemyTags),
	alignof(FAGLS_HumanAI_EnemyTags),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000001),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags()
{
	if (!Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags.InnerSingleton, Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform;
class UScriptStruct* FCALS_ComponentAndTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCALS_ComponentAndTransform, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("CALS_ComponentAndTransform"));
	}
	return Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform.InnerSingleton, Z_Construct_UScriptStruct_FCALS_ComponentAndTransform_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC;
class UScriptStruct* FCMC_SingleClimbPointC::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCMC_SingleClimbPointC, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("CMC_SingleClimbPointC"));
	}
	return Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC.InnerSingleton, Z_Construct_UScriptStruct_FCMC_SingleClimbPointC_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FCMC_LedgeC;
class UScriptStruct* FCMC_LedgeC::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FCMC_LedgeC.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FCMC_LedgeC.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCMC_LedgeC, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("CMC_LedgeC"));
	}
	return Z_Registration_Info_UScriptStruct_FCMC_LedgeC.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FCMC_LedgeC.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FCMC_LedgeC.InnerSingleton, Z_Construct_UScriptStruct_FCMC_LedgeC_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FCMC_LedgeC.InnerSingleton;
}
// ********** End ScriptStruct FCMC_LedgeC *********************************************************

// ********** Begin ScriptStruct FTraversalStateEvaluation *****************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation;
class UScriptStruct* FTraversalStateEvaluation::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTraversalStateEvaluation, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("TraversalStateEvaluation"));
	}
	return Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation.InnerSingleton, Z_Construct_UScriptStruct_FTraversalStateEvaluation_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation.InnerSingleton;
}
// ********** End ScriptStruct FTraversalStateEvaluation *******************************************

// ********** Begin ScriptStruct FTraversalSingeAnimAsset ******************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset;
class UScriptStruct* FTraversalSingeAnimAsset::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTraversalSingeAnimAsset, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("TraversalSingeAnimAsset"));
	}
	return Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset.InnerSingleton, Z_Construct_UScriptStruct_FTraversalSingeAnimAsset_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset.InnerSingleton;
}
// ********** End ScriptStruct FTraversalSingeAnimAsset ********************************************

// ********** Begin ScriptStruct FCALSMovementSettingsStrafe ***************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe;
class UScriptStruct* FCALSMovementSettingsStrafe::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCALSMovementSettingsStrafe, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("CALSMovementSettingsStrafe"));
	}
	return Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe.InnerSingleton, Z_Construct_UScriptStruct_FCALSMovementSettingsStrafe_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe.InnerSingleton;
}
// ********** End ScriptStruct FCALSMovementSettingsStrafe *****************************************

// ********** Begin ScriptStruct FCALS_PropsAttachValues *******************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues;
class UScriptStruct* FCALS_PropsAttachValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCALS_PropsAttachValues, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("CALS_PropsAttachValues"));
	}
	return Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues.InnerSingleton, Z_Construct_UScriptStruct_FCALS_PropsAttachValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues.InnerSingleton;
}
// ********** End ScriptStruct FCALS_PropsAttachValues *********************************************

// ********** Begin ScriptStruct FAGLS_FinishersDataForAI ******************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FAGLS_FinishersDataForAI;
class UScriptStruct* FAGLS_FinishersDataForAI::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FAGLS_FinishersDataForAI.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FAGLS_FinishersDataForAI.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAGLS_FinishersDataForAI, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("AGLS_FinishersDataForAI"));
	}
	return Z_Registration_Info_UScriptStruct_FAGLS_FinishersDataForAI.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FAGLS_FinishersDataForAI.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FAGLS_FinishersDataForAI.InnerSingleton, Z_Construct_UScriptStruct_FAGLS_FinishersDataForAI_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FAGLS_FinishersDataForAI.InnerSingleton;
}
// ********** End ScriptStruct FAGLS_FinishersDataForAI ********************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_ALS_StructuresAndEnumsCpp_h__Script_HelpfulFunctions_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ AGLS_HumanAI_PatrolingMode_StaticEnum, TEXT("AGLS_HumanAI_PatrolingMode"), &Z_Registration_Info_UEnum_AGLS_HumanAI_PatrolingMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2758293038U) },
		{ AGLS_HumanAI_FightingMode_StaticEnum, TEXT("AGLS_HumanAI_FightingMode"), &Z_Registration_Info_UEnum_AGLS_HumanAI_FightingMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3024899547U) },
		{ AGLS_HumanAI_SightStatus_StaticEnum, TEXT("AGLS_HumanAI_SightStatus"), &Z_Registration_Info_UEnum_AGLS_HumanAI_SightStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2873589976U) },
		{ AGLS_LOD_State_StaticEnum, TEXT("AGLS_LOD_State"), &Z_Registration_Info_UEnum_AGLS_LOD_State, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 270714742U) },
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FAGLS_HumanAI_EnemyTags::StaticStruct, Z_Construct_UScriptStruct_FAGLS_HumanAI_EnemyTags_Statics::NewStructOps, TEXT("AGLS_HumanAI_EnemyTags"), &Z_Registration_Info_UScriptStruct_FAGLS_HumanAI_EnemyTags, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAGLS_HumanAI_EnemyTags), 3925701258U) },
		{ FCALS_ComponentAndTransform::StaticStruct, Z_Construct_UScriptStruct_FCALS_ComponentAndTransform_Statics::NewStructOps, TEXT("CALS_ComponentAndTransform"), &Z_Registration_Info_UScriptStruct_FCALS_ComponentAndTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCALS_ComponentAndTransform), 3957716472U) },
		{ FCMC_SingleClimbPointC::StaticStruct, Z_Construct_UScriptStruct_FCMC_SingleClimbPointC_Statics::NewStructOps, TEXT("CMC_SingleClimbPointC"), &Z_Registration_Info_UScriptStruct_FCMC_SingleClimbPointC, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCMC_SingleClimbPointC), 3660831039U) },
		{ FCMC_LedgeC::StaticStruct, Z_Construct_UScriptStruct_FCMC_LedgeC_Statics::NewStructOps, TEXT("CMC_LedgeC"), &Z_Registration_Info_UScriptStruct_FCMC_LedgeC, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCMC_LedgeC), 1648806190U) },
		{ FTraversalStateEvaluation::StaticStruct, Z_Construct_UScriptStruct_FTraversalStateEvaluation_Statics::NewStructOps, TEXT("TraversalStateEvaluation"), &Z_Registration_Info_UScriptStruct_FTraversalStateEvaluation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTraversalStateEvaluation), 4053187277U) },
		{ FTraversalSingeAnimAsset::StaticStruct, Z_Construct_UScriptStruct_FTraversalSingeAnimAsset_Statics::NewStructOps, TEXT("TraversalSingeAnimAsset"), &Z_Registration_Info_UScriptStruct_FTraversalSingeAnimAsset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTraversalSingeAnimAsset), 1638947521U) },
		{ FCALSMovementSettingsStrafe::StaticStruct, Z_Construct_UScriptStruct_FCALSMovementSettingsStrafe_Statics::NewStructOps, TEXT("CALSMovementSettingsStrafe"), &Z_Registration_Info_UScriptStruct_FCALSMovementSettingsStrafe, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCALSMovementSettingsStrafe), 1354733799U) },
		{ FCALS_PropsAttachValues::StaticStruct, Z_Construct_UScriptStruct_FCALS_PropsAttachValues_Statics::NewStructOps, TEXT("CALS_PropsAttachValues"), &Z_Registration_Info_UScriptStruct_FCALS_PropsAttachValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCALS_PropsAttachValues), 3752124143U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_ALS_StructuresAndEnumsCpp_h__Script_HelpfulFunctions_494380261(TEXT("/Script/HelpfulFunctions"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_ALS_StructuresAndEnumsCpp_h__Script_HelpfulFunctions_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_ALS_StructuresAndEnumsCpp_h__Script_HelpfulFunctions_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_ALS_StructuresAndEnumsCpp_h__Script_HelpfulFunctions_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_ALS_StructuresAndEnumsCpp_h__Script_HelpfulFunctions_Statics::EnumInfo));
// ********** End Registration *********************************************************************
