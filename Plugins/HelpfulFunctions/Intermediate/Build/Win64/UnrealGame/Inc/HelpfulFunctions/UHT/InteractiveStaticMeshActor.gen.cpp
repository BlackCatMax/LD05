...
FClassRegistrationInfo Z_Registration_Info_UClass_AInteractiveStaticMeshActor;
UClass* AInteractiveStaticMeshActor::GetPrivateStaticClass()
{
	using TClass = AInteractiveStaticMeshActor;
	if (!Z_Registration_Info_UClass_AInteractiveStaticMeshActor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("InteractiveStaticMeshActor"),
			Z_Registration_Info_UClass_AInteractiveStaticMeshActor.InnerSingleton,
			StaticRegisterNativesAInteractiveStaticMeshActor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AInteractiveStaticMeshActor.InnerSingleton;
}
UClass* Z_Construct_UClass_AInteractiveStaticMeshActor_NoRegister()
{
	return AInteractiveStaticMeshActor::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AInteractiveStaticMeshActor_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AInteractiveStaticMeshActor_ForceDestroyWidget, "ForceDestroyWidget" }, // 4289832417
		{ &Z_Construct_UFunction_AInteractiveStaticMeshActor_GetInteractionState, "GetInteractionState" }, // 3905986476
		{ &Z_Construct_UFunction_AInteractiveStaticMeshActor_UpdateInteractionState, "UpdateInteractionState" }, // 2040055054
	};
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AInteractiveStaticMeshActor_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UInteractiveActorsInterface_NoRegister, (int32)VTABLE_OFFSET(AInteractiveStaticMeshActor, IInteractiveActorsInterface), false },  // 2720460363
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_InteractiveStaticMeshActor_h__Script_HelpfulFunctions_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_InteractiveStaticMeshActor_h__Script_HelpfulFunctions_988362814(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_InteractiveStaticMeshActor_h__Script_HelpfulFunctions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_InteractiveStaticMeshActor_h__Script_HelpfulFunctions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
