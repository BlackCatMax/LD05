...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FCharMovementValues;
class UScriptStruct* FCharMovementValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FCharMovementValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FCharMovementValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharMovementValues, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("CharMovementValues"));
	}
	return Z_Registration_Info_UScriptStruct_FCharMovementValues.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FCharMovementValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FCharMovementValues.InnerSingleton, Z_Construct_UScriptStruct_FCharMovementValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FCharMovementValues.InnerSingleton;
}
// ********** End ScriptStruct FCharMovementValues *************************************************

// ********** Begin ScriptStruct FSlidingConditionData *********************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FSlidingConditionData;
class UScriptStruct* FSlidingConditionData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FSlidingConditionData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FSlidingConditionData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSlidingConditionData, (UObject*)Z_Construct_UPackage__Script_HelpfulFunctions(), TEXT("SlidingConditionData"));
	}
	return Z_Registration_Info_UScriptStruct_FSlidingConditionData.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FSlidingConditionData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FSlidingConditionData.InnerSingleton, Z_Construct_UScriptStruct_FSlidingConditionData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FSlidingConditionData.InnerSingleton;
}
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UCpp_FallDamageAndSliding_SimpleTrajectoryC_Statics::NewProp_ReturnAllHits = { "ReturnAllHits", nullptr, (EPropertyFlags)0x0010008000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Cpp_FallDamageAndSliding_eventSimpleTrajectoryC_Parms, ReturnAllHits), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 267591329
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UCpp_FallDamageAndSliding_SimpleTrajectoryC_Statics::NewProp_ReturnWalkableHits = { "ReturnWalkableHits", nullptr, (EPropertyFlags)0x0010008000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Cpp_FallDamageAndSliding_eventSimpleTrajectoryC_Parms, ReturnWalkableHits), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 267591329
...
FClassRegistrationInfo Z_Registration_Info_UClass_UCpp_FallDamageAndSliding;
UClass* UCpp_FallDamageAndSliding::GetPrivateStaticClass()
{
	using TClass = UCpp_FallDamageAndSliding;
	if (!Z_Registration_Info_UClass_UCpp_FallDamageAndSliding.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("Cpp_FallDamageAndSliding"),
			Z_Registration_Info_UClass_UCpp_FallDamageAndSliding.InnerSingleton,
			StaticRegisterNativesUCpp_FallDamageAndSliding,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UCpp_FallDamageAndSliding.InnerSingleton;
}
UClass* Z_Construct_UClass_UCpp_FallDamageAndSliding_NoRegister()
{
	return UCpp_FallDamageAndSliding::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UCpp_FallDamageAndSliding_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_CheckCanMantleOnEdge, "CheckCanMantleOnEdge" }, // 1255596416
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_CheckCanStartSlidingC, "CheckCanStartSlidingC" }, // 207790581
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_PrepareToSlidingC, "PrepareToSlidingC" }, // 383060776
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_SimpleTrajectoryC, "SimpleTrajectoryC" }, // 1789654390
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_SlidingConditionC, "SlidingConditionC" }, // 1559928136
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_UpdateAngleCorrectDurningSliding, "UpdateAngleCorrectDurningSliding" }, // 3017985012
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_UpdateCharFrictionDurningSliding, "UpdateCharFrictionDurningSliding" }, // 2973197035
		{ &Z_Construct_UFunction_UCpp_FallDamageAndSliding_UpdateCharWalkAngleDurningSliding, "UpdateCharWalkAngleDurningSliding" }, // 4223705094
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_FallDamageAndSliding_h__Script_HelpfulFunctions_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FCharMovementValues::StaticStruct, Z_Construct_UScriptStruct_FCharMovementValues_Statics::NewStructOps, TEXT("CharMovementValues"), &Z_Registration_Info_UScriptStruct_FCharMovementValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCharMovementValues), 634067386U) },
		{ FSlidingConditionData::StaticStruct, Z_Construct_UScriptStruct_FSlidingConditionData_Statics::NewStructOps, TEXT("SlidingConditionData"), &Z_Registration_Info_UScriptStruct_FSlidingConditionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSlidingConditionData), 126861029U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCpp_FallDamageAndSliding, UCpp_FallDamageAndSliding::StaticClass, TEXT("UCpp_FallDamageAndSliding"), &Z_Registration_Info_UClass_UCpp_FallDamageAndSliding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCpp_FallDamageAndSliding), 1022972456U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_FallDamageAndSliding_h__Script_HelpfulFunctions_3509183299(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_FallDamageAndSliding_h__Script_HelpfulFunctions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_FallDamageAndSliding_h__Script_HelpfulFunctions_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_FallDamageAndSliding_h__Script_HelpfulFunctions_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_Cpp_FallDamageAndSliding_h__Script_HelpfulFunctions_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
