...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_HelpfulFunctions, nullptr, "OnAssetsLoaded__DelegateSignature", Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature_Statics::_Script_HelpfulFunctions_eventOnAssetsLoaded_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00530000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature_Statics::Function_MetaDataParams)},  };
...
UFunction* Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_HelpfulFunctions_OnAssetsLoaded__DelegateSignature_Statics::FuncParams);
	}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UAsyncLoadAssetsNode;
UClass* UAsyncLoadAssetsNode::GetPrivateStaticClass()
{
	using TClass = UAsyncLoadAssetsNode;
	if (!Z_Registration_Info_UClass_UAsyncLoadAssetsNode.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AsyncLoadAssetsNode"),
			Z_Registration_Info_UClass_UAsyncLoadAssetsNode.InnerSingleton,
			StaticRegisterNativesUAsyncLoadAssetsNode,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAsyncLoadAssetsNode.InnerSingleton;
}
UClass* Z_Construct_UClass_UAsyncLoadAssetsNode_NoRegister()
{
	return UAsyncLoadAssetsNode::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UAsyncLoadAssetsNode_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAsyncLoadAssetsNode_AsyncLoadAssetArray, "AsyncLoadAssetArray" }, // 2514235681
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AsyncLoadAssetsNode_h__Script_HelpfulFunctions_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AsyncLoadAssetsNode_h__Script_HelpfulFunctions_3532390696(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AsyncLoadAssetsNode_h__Script_HelpfulFunctions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_UE5_6_AGLS_v1_6_0_Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AsyncLoadAssetsNode_h__Script_HelpfulFunctions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
